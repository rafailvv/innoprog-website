...
const frontendMobileProjects = [
  {
    title: "Адаптивный сайт-портфолио frontend-разработчика",
    description: "Разработаете многостраничное или SPA-портфолио с проектами, контактной формой, адаптивной сеткой, темной темой и базовой аналитикой действий пользователей",
  },
  {
    title: "Лендинг цифрового продукта с формой заявки",
    description: "Создадите промо-страницу с преимуществами, тарифами, отзывами, формой заявки, валидацией, модальным окном и полноценной мобильной адаптацией",
  },
  {
    title: "Интерактивный каталог фильмов или книг",
    description: "Соберете каталог с поиском, фильтрами, карточками, избранным, пагинацией и запросами к API или mock-сервису",
  },
  {
    title: "Task manager с авторизационным сценарием",
    description: "Создадите приложение для задач с досками, статусами, фильтрацией, формами, локальным или серверным хранением и защищенными маршрутами",
  },
  {
    title: "Погодный dashboard",
    description: "Разработаете интерфейс прогноза погоды с выбором города, историей поиска, графиком, обработкой ошибок API и адаптивной визуализацией",
  },
  {
    title: "Интернет-магазин с каталогом и корзиной",
    description: "Создадите клиентскую часть магазина с карточками товаров, фильтрами, корзиной, расчетом стоимости, оформлением заказа и сохранением состояния",
  },
  {
    title: "Сервис бронирования услуг",
    description: "Разработаете интерфейс выбора услуги, специалиста, даты и времени с формой клиента, проверкой доступности и подтверждением записи",
  },
  {
    title: "Административная панель управления заявками",
    description: "Соберете dashboard для списка заявок, статусов, карточки клиента, поиска, фильтров, таблиц, модальных окон и ролей пользователя",
  },
  {
    title: "Образовательная платформа с личным кабинетом",
    description: "Разработаете интерфейс курсов, уроков, прогресса, домашних заданий, уведомлений и пользовательского профиля",
  },
  {
    title: "Мини CRM для работы с клиентами",
    description: "Создадите SPA-приложение с карточками клиентов, задачами, комментариями, фильтрацией, статусами и историей действий",
  },
  {
    title: "UI-kit и демонстрационное приложение",
    description: "Разработаете набор компонентов с документацией, состояниями, дизайн-токенами и демонстрационными страницами",
  },
  {
    title: "Чат-интерфейс для учебного сервиса",
    description: "Создадите интерфейс чатов, списка диалогов, сообщений, статусов отправки, поиска, пустых состояний и адаптивной мобильной версии",
  },
  {
    title: "Дашборд аналитики продукта",
    description: "Разработаете интерфейс метрик, графиков, фильтров периода, таблиц, карточек показателей и состояний загрузки данных",
  },
  {
    title: "PWA-приложение для личных привычек",
    description: "Создадите приложение с трекером привычек, офлайн-режимом, локальным хранением, календарем и уведомительными состояниями",
  },
  {
    title: "Личный кабинет ученика онлайн-школы",
    description: "Реализуете веб-кабинет с расписанием занятий, прогрессом по курсу, домашними заданиями, уведомлениями, профилем ученика, API-интеграцией и адаптивной версткой",
  },
];
...
function FrontendMobileProjectCard({ project, index }: { project: typeof frontendMobileProjects[number]; index: number }) {
  return (
...
function Frame148() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start relative shrink-0 text-white uppercase w-[350px]">
      ...
      <h1 className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[36px] w-full">
        <span className="block leading-[40px]">Frontend-</span>
        <span className="block leading-[40px]">разработчик</span>
      </h1>
    </div>
  );
}
...
function Frame237() {
  return (
    <div className="bg-[rgba(255,255,255,0.6)] col-1 content-stretch flex flex-col h-[537px] items-end justify-between ml-0 mt-0 overflow-clip p-[24px] relative rounded-[40px] row-1 w-[350px]">
      <div className="absolute h-[393px] left-[-172px] top-[72px] w-[551px]" data-name="Иллюстрация окна с кодом" style={{ mixBlendMode: "color-burn" }}>
        <img
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[20px] text-center text-white uppercase w-[350px]">
        ...
        <p className="leading-[20px]">React и TypeScript</p>
      </div>
      <Frame65 />
      <Frame181 />
    </div>
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[24px] items-start leading-[0] relative shrink-0 text-black w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Bold',sans-serif] font-bold relative shrink-0 text-[20px] uppercase w-full">
        <p className="leading-[20px]"><span>Frontend-разработчик создает интерфейсы, SPA-приложения</span><br /><span>и интеграции с API</span></p>
      </div>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal relative shrink-0 text-[16px] tracking-[0.48px] w-full whitespace-pre-wrap">
        <p className="leading-[18px]"><span>На курсе вы проходите полный цикл frontend-разработки: верстку, JavaScript, TypeScript, React</span><br /><span>работу с API, тестирование, доступность и подготовку проекта к деплою.</span><br /><span>Программа помогает собрать портфолио и подготовиться к первым задачам frontend-разработчика.</span></p>
      </div>
    </div>
  );
}
...
function Frame276() {
  return (
    <div className="[word-break:break-word] content-stretch flex font-['Manrope:ExtraBold',sans-serif] font-extrabold items-center justify-between leading-[20px] relative shrink-0 text-[#464a6a] text-[16px] text-center tracking-[0.48px] uppercase w-[350px]">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-[111px]">{`от 79 500 р.`}</p>
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-[114px]">{`от 142 100 р.`}</p>
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-[111px]">{`от 276 700 р.`}</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-start relative shrink-0 w-full">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[0] relative shrink-0 text-[32px] text-black uppercase w-full">
        <p className="leading-[32px] mb-0">Уровень дохода frontend-разработчика</p>
...
function Frame114() {
  return (
    <div className="content-stretch flex flex-col font-['Manrope:Bold',sans-serif] font-bold gap-[8px] items-start relative shrink-0 w-[131px]">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] leading-[18px] relative shrink-0 w-full">Frontend-разработчик</p>
...
function Frame87() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start leading-[20px] relative shrink-0 text-black text-right w-[128px]">
      ...
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Bold',sans-serif] font-bold relative shrink-0 text-[14px] uppercase whitespace-nowrap w-full">от 79 500 р.</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
            <span className="leading-[19px]">Настраиваю Vite, линтеры,</span>
          </li>
        </ul>
        <p className="leading-[19px]">тесты и публикацию приложения</p>
      </div>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[21px]">
          <span className="leading-[19px]">Собираю и публикую frontend-приложения</span>
        </li>
      </ul>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
            <span className="leading-[19px]">Проверяю компоненты и сценарии с помощью</span>
          </li>
        </ul>
        <p className="leading-[19px]">Testing Library и Playwright</p>
      </div>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[21px]">
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col font-['Manrope:Regular',sans-serif] font-normal gap-[8px] items-start leading-[0] relative shrink-0 text-[14px] text-black tracking-[0.42px] w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
            <span className="leading-[19px]">Верстаю адаптивные страницы</span>
          </li>
        </ul>
        <p className="leading-[19px]">для веб-приложений и интерфейсов</p>
      </div>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
            <span className="leading-[19px]">Пишу JavaScript и TypeScript для</span>
          </li>
        </ul>
        <p className="leading-[19px]">интерфейсов, API и frontend-разработки</p>
      </div>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
            <span className="leading-[19px]">Создаю React-компоненты и проверяю</span>
          </li>
        </ul>
      ...
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[21px]">
          <span className="leading-[19px]">Работаю с API, состоянием и маршрутизацией</span>
        </li>
      </ul>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
            <span className="leading-[19px]">Подключаю API для веб-приложений</span>
          </li>
        </ul>
...
function Frame135() {
  return (
    <div className="content-stretch flex gap-[8px] items-center p-[8px] relative rounded-[16px] shrink-0">
      <div aria-hidden className="absolute border border-black border-solid inset-0 pointer-events-none rounded-[16px]" />
      <DeviconFastapi />
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[18px] relative shrink-0 text-[16px] text-black tracking-[0.48px] whitespace-nowrap">TypeScript</p>
    </div>
  );
}
...
function Frame123() {
  return (
    <div className="content-stretch flex gap-[8px] items-center p-[8px] relative rounded-[16px] shrink-0">
      ...
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[18px] relative shrink-0 text-[16px] text-black tracking-[0.48px] whitespace-nowrap">React</p>
    </div>
  );
}
...
function Frame132() {
  return (
    <div className="content-stretch flex gap-[8px] items-center p-[8px] relative rounded-[16px] shrink-0">
      ...
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[18px] relative shrink-0 text-[16px] text-black tracking-[0.48px] whitespace-nowrap">Vite</p>
    </div>
  );
}
...
const mobileFrontendTechColors: Record<string, string> = {
  HTML5: "#e34f26",
  CSS3: "#1572b6",
  JavaScript: "#f7df1e",
  TypeScript: "#3178c6",
...
function MobileFrontendTechChip({ label }: { label: string; short: string }) {
  return (
    <div className="content-stretch flex gap-[8px] items-center p-[8px] relative rounded-[16px] shrink-0">
      <div aria-hidden className="absolute border border-black border-solid inset-0 pointer-events-none rounded-[16px]" />
      <CourseSkillIcon label={label} size={16} />
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[18px] relative shrink-0 text-[16px] text-black tracking-[0.48px] whitespace-nowrap">{label}</p>
    </div>
  );
}
  ...
  return (
    <div className="site-course-tech-stack content-stretch flex flex-wrap gap-[8px] items-center justify-center relative shrink-0 w-[350px]">
      <div className="site-course-tech-row relative shrink-0">
        <MobileFrontendTechChip label="HTML5" short="H5" />
        <MobileFrontendTechChip label="CSS3" short="CSS" />
        <MobileFrontendTechChip label="JavaScript" short="JS" />
      </div>
      <div className="site-course-tech-row relative shrink-0">
        <MobileFrontendTechChip label="TypeScript" short="TS" />
        <MobileFrontendTechChip label="React" short="R" />
        <MobileFrontendTechChip label="Vite" short="V" />
      </div>
      <div className="site-course-tech-row relative shrink-0">
        <MobileFrontendTechChip label="Node.js" short="N" />
        <MobileFrontendTechChip label="Git" short="Git" />
        <MobileFrontendTechChip label="Tailwind CSS" short="TW" />
      </div>
      <div className="site-course-tech-row relative shrink-0">
        <MobileFrontendTechChip label="Figma" short="F" />
        <MobileFrontendTechChip label="Storybook" short="SB" />
      </div>
      <div className="site-course-tech-row relative shrink-0">
        <MobileFrontendTechChip label="Testing Library" short="TL" />
        <MobileFrontendTechChip label="Playwright" short="PW" />
      </div>
      <div className="site-course-tech-row site-course-tech-row--last relative shrink-0">
        <MobileFrontendTechChip label="REST API" short="API" />
        <MobileFrontendTechChip label="VS Code" short="VS" />
      </div>
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[40px] items-center px-[20px] relative size-full">
          ...
          <Frame192 />
          <CourseSkillList course="frontend" variant="mobile" />
        </div>
      </div>
    </div>
  );
...
function Frame91() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start leading-[0] relative shrink-0 text-white w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold relative shrink-0 text-[24px] uppercase w-full">
        <p className="leading-[27px] mb-0">15 проектных работ</p>
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-start relative shrink-0 text-black w-full">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[16px] tracking-[0.48px] w-full">
        ...
        <p className="leading-[18px]">который помогает выбрать услугу, специалиста, дату и время, проверить доступность и подтвердить запись</p>
      </div>
    </div>
  );
}
...
function Frame73() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-start relative shrink-0 text-black w-full">
      ...
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[18px] relative shrink-0 text-[16px] tracking-[0.48px] w-full">Разработаете интерфейс бронирования услуг с выбором специалиста, даты, времени, формой клиента и подтверждением записи</p>
    </div>
  );
}
...
function Frame80() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-start relative shrink-0 text-black w-full">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[27px] relative shrink-0 text-[24px] uppercase w-full">Storybook-приложение интернет-магазина</p>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[16px] tracking-[0.48px] w-full">
        <p className="leading-[18px] mb-0">Разработаете клиентскую часть интернет-магазина с каталогом товаров, карточками, корзиной</p>
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-start leading-[0] relative shrink-0 text-black w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold relative shrink-0 text-[24px] uppercase w-full">
        ...
        <p className="leading-[27px]">на React</p>
      </div>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal relative shrink-0 text-[16px] tracking-[0.48px] w-full">
        <p className="leading-[18px] mb-0">Разработаете полноценный веб-проект</p>
        <p className="leading-[18px] mb-0">с React, TypeScript, фильтрами, корзиной, API, тестами и деплоем</p>
...
function Frame197() {
  return (
    <div className="content-stretch flex gap-[20px] items-start relative shrink-0 w-full site-carousel site-course-projects-carousel" data-carousel="python-mobile-projects">
      {frontendMobileProjects.map((project, index) => (
        <FrontendMobileProjectCard index={index} key={project.title} project={project} />
      ))}
    </div>
  );
}
...
function Frame98() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(1) Вводный модуль</p>
...
function Frame99() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(2) HTML, CSS и адаптивная верстка</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame105() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(4) Git и командная разработка</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame106() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-pre">{`(5) Инструменты разработки и Linux  `}</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame107() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(6) React и компонентная архитектура</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame108() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(7) Маршрутизация, состояние и API</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame109() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(8) Тестирование и доступность</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame113() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(11) Итоговая аттестация</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame200() {
  return (
    <div className="content-stretch flex flex-col gap-[80px] items-center relative shrink-0 w-full">
      ...
      <Frame198 />
      <Frame280 />
      <MainScreenMobileTeachersSection preferredRole="Frontend-разработчик" />
  ...
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-[350px]">
      ...
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        ...
        <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Regular',sans-serif] font-normal leading-[18px] min-w-px relative text-[16px] text-white tracking-[0.48px]">15 проектных работ в портфолио</p>
      </div>
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <div className="relative shrink-0 size-[18px]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
...
function Frame283() {
  return (
    <div className="content-stretch flex gap-[16px] items-end justify-center relative shrink-0">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [text-decoration-skip-ink:none] [text-underline-position:from-font] [word-break:break-word] decoration-from-font decoration-solid font-['Manrope:Bold',sans-serif] font-bold leading-[31px] line-through relative shrink-0 text-[24px] text-[rgba(0,0,0,0.4)] text-center uppercase whitespace-nowrap">23 590 р./мес.</p>
      <Frame271 />
    </div>
  );
}
...
function Frame155() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center justify-center relative shrink-0">
      <Frame283 />
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[#9c78ff] text-[40px] text-center uppercase whitespace-nowrap">14 390 р./мес.</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-[350px]">
      ...
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        ...
        <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Regular',sans-serif] font-normal leading-[18px] min-w-px relative text-[#464a6a] text-[16px] tracking-[0.48px]">15 проектных работ в портфолио</p>
      </div>
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <div className="relative shrink-0 size-[18px]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
...
function Frame284() {
  return (
    <div className="content-stretch flex gap-[16px] items-end justify-center relative shrink-0">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [text-decoration-skip-ink:none] [text-underline-position:from-font] [word-break:break-word] decoration-from-font decoration-solid font-['Manrope:Bold',sans-serif] font-bold leading-[31px] line-through relative shrink-0 text-[24px] text-[rgba(0,0,0,0.4)] text-center uppercase whitespace-nowrap">31 950 р./мес.</p>
      <Frame272 />
    </div>
  );
}
...
function Frame160() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center justify-center relative shrink-0">
      <Frame284 />
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[40px] text-center text-white uppercase w-[312px]">18 890 р./мес.</p>
    </div>
  );
}
  ...
  return (
    <div aria-checked="false" className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full site-consent site-course-consent" data-consent-toggle role="checkbox" tabIndex={0}>
      ...
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Regular',sans-serif] font-normal leading-[0] min-w-px relative text-[0px] text-white">
        ...
        <a className="cursor-pointer font-['Manrope:Bold',sans-serif] font-bold leading-[16px] site-consent__link text-[12px]" href="/consent" rel="noopener noreferrer" target="_blank">
          <span>согласие на обработку персональных данных</span>
        </a>
        <span className="leading-[16px] text-[12px]">{` и соглашаетесь с `}</span>
        <a className="cursor-pointer font-['Manrope:Bold',sans-serif] font-bold leading-[16px] site-consent__link text-[12px]" href="/privacy" rel="noopener noreferrer" target="_blank">
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Medium',sans-serif] font-medium leading-[0] min-w-px relative text-[20px] text-black text-left uppercase">
        <p className="leading-[22px] mb-0">Слышал, что frontend -</p>
...
export default function FrontendCourseMobile() {
  return (
