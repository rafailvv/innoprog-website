...
import imgUnrealEngineHero from "../MainScreenDesktop/e6d0013835ce90ccca46f42fb5480d9fab91d85f.opt.webp";
import imgImage119 from "../UnrealEngineCourseDesktop/personal-mentor.gif";
...
const unrealEngineMobileProjects = [
  {
...
function UnrealEngineMobileProjectCard({ project, index }: { project: typeof unrealEngineMobileProjects[number]; index: number }) {
  return (
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start relative shrink-0 text-white uppercase w-[350px]">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[40px] w-full">
        <p className="leading-[43px] mb-0">Unreal Engine 5</p>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[20px] text-center text-white uppercase w-[350px]">
        ...
        <p className="leading-[20px] mb-0">Unreal Engine 5</p>
        <p className="leading-[20px]">Blueprint, UMG, AI и публикацию</p>
      </div>
      <Frame65 />
      <Frame181 />
    </div>
...
function Frame276() {
  return (
    <div className="[word-break:break-word] content-stretch flex font-['Manrope:ExtraBold',sans-serif] font-extrabold items-center justify-between leading-[20px] relative shrink-0 text-[#464a6a] text-[16px] text-center tracking-[0.48px] uppercase w-[350px]">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-[111px]">{`от 100 000 ₽`}</p>
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-[114px]">{`от 158 600 ₽`}</p>
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-[111px]">{`от 235 000 ₽`}</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-start relative shrink-0 w-full">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[0] relative shrink-0 text-[32px] text-black uppercase w-full">
        <p className="leading-[32px] mb-0">Уровень дохода Unreal Engine-разработчика</p>
...
function Frame114() {
  return (
    <div className="content-stretch flex flex-col font-['Manrope:Bold',sans-serif] font-bold gap-[8px] items-start relative shrink-0 w-[131px]">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] leading-[18px] relative shrink-0 w-full">Unreal Engine</p>
...
function Frame87() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start leading-[20px] relative shrink-0 text-black text-right w-[128px]">
      ...
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Bold',sans-serif] font-bold relative shrink-0 text-[14px] uppercase whitespace-nowrap w-full">от 100 000 ₽</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
            <span className="leading-[19px]">Настраиваю проект, Blueprint,</span>
          </li>
        </ul>
        <p className="leading-[19px]">тесты, отладку и сборку игрового прототипа</p>
      </div>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[21px]">
          <span className="leading-[19px]">Готовлю build, README и демонстрацию проекта</span>
        </li>
      </ul>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
      ...
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[21px]">
          <span className="leading-[19px]">Публикую проект на itch.io</span>
        </li>
      </ul>
    </div>
  );
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col font-['Manrope:Regular',sans-serif] font-normal gap-[8px] items-start leading-[0] relative shrink-0 text-[14px] text-black tracking-[0.42px] w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        ...
        <p className="leading-[19px]">для игровых проектов</p>
      </div>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
            <span className="leading-[19px]">Создаю Blueprint-логику для</span>
          </li>
        </ul>
        <p className="leading-[19px]">алгоритмов, классов и разработки игр на Unreal Engine</p>
      </div>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
      ...
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[21px]">
          <span className="leading-[19px]">Подключаю API, Actors, HTTP и авторизацию</span>
        </li>
      </ul>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
            <span className="leading-[19px]">Готовлю игровой проект к сборке</span>
          </li>
        </ul>
  ...
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <div className="content-stretch flex gap-[16px] h-[32px] items-center p-[8px] relative rounded-[16px] shrink-0 w-[105px]">
        ...
        <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[18px] relative shrink-0 text-[16px] text-black tracking-[0.48px] whitespace-nowrap">Unreal Engine 5</p>
      </div>
      <Frame133 />
      <Frame135 />
    </div>
...
const mobileUnrealEngineTechColors: Record<string, string> = {
...
function MobileUnrealEngineTechChip({ label, short }: { label: string; short: string }) {
  const color = mobileUnrealEngineTechColors[label] || "#9c78ff";
  ...
  return (
    <div className="site-course-tech-stack content-stretch flex flex-wrap gap-[8px] items-center justify-center relative shrink-0 w-[350px]">
      <div className="site-course-tech-row relative shrink-0">
        <MobileUnrealEngineTechChip label="Blueprint" short="Blueprint" />
        <MobileUnrealEngineTechChip label="Unreal Engine 5" short="UE5" />
        <MobileUnrealEngineTechChip label="UMG" short="AN" />
      </div>
      <div className="site-course-tech-row relative shrink-0">
        <MobileUnrealEngineTechChip label="State Tree" short="State Tree" />
        <MobileUnrealEngineTechChip label="Collision" short="COL" />
        <MobileUnrealEngineTechChip label="Actors" short="Actors" />
      </div>
      <div className="site-course-tech-row relative shrink-0">
        <MobileUnrealEngineTechChip label="Level Design" short="LVL" />
        <MobileUnrealEngineTechChip label="itch.io" short="ITCH" />
        <MobileUnrealEngineTechChip label="Git" short="Git" />
      </div>
      <div className="site-course-tech-row site-course-tech-row--last relative shrink-0">
        <MobileUnrealEngineTechChip label="Profiling" short="PROF" />
      </div>
    </div>
  );
}
...
function Frame91() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start leading-[0] relative shrink-0 text-white w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold relative shrink-0 text-[24px] uppercase w-full">
        <p className="leading-[27px] mb-0">6 игровых проектов</p>
...
function Frame70() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-start leading-[0] relative shrink-0 text-black w-full">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal relative shrink-0 text-[16px] tracking-[0.48px] w-full">
        <p className="leading-[18px] mb-0">Разработаете игровой прототип для постановки, отслеживания и закрытия задач,</p>
...
function Frame76() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-start relative shrink-0 text-black w-full">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[27px] relative shrink-0 text-[24px] uppercase w-full">Веб-игровой прототип прогноза погоды</p>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[16px] tracking-[0.48px] w-full">
...
function Frame80() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-start relative shrink-0 text-black w-full">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[27px] relative shrink-0 text-[24px] uppercase w-full">(10) Проектная практика-игровой прототип интернет-магазина</p>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[16px] tracking-[0.48px] w-full">
...
function Frame82() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-start leading-[0] relative shrink-0 text-black w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold relative shrink-0 text-[24px] uppercase w-full">
        <p className="leading-[27px] mb-0">Итоговый игровой прототип</p>
        <p className="leading-[27px]">для портфолио</p>
      </div>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal relative shrink-0 text-[16px] tracking-[0.48px] w-full">
        <p className="leading-[18px] mb-0">Разработаете полноценный игровой проект</p>
        <p className="leading-[18px] mb-0">с архитектурой, тестами, README, сборкой и релизной конфигурацией</p>
        <p className="leading-[18px]">с логичной архитектурой, приближенной к реальным требованиям разработки игр на Unreal Engine</p>
      </div>
    </div>
  );
}
...
function Frame197() {
  return (
    <div className="content-stretch flex gap-[20px] items-start relative shrink-0 w-full site-carousel site-course-projects-carousel" data-carousel="python-mobile-projects">
      {unrealEngineMobileProjects.map((project, index) => (
        <UnrealEngineMobileProjectCard index={index} key={project.title} project={project} />
      ))}
    </div>
  );
}
...
function Frame99() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(2) Знакомство с Unreal Engine 5</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame105() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(4) Разработка базовых механик игры</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame106() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-pre">{`(5) Моделирование, свет и базовый шейдер  `}</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame107() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(6) Кастомный персонаж, управление и камера</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame108() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(7) Коллизии и взаимодействие объектов</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame109() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(8) Основы AI с использованием State Tree</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
  ...
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-[350px]">
      ...
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        ...
        <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Regular',sans-serif] font-normal leading-[18px] min-w-px relative text-[16px] text-white tracking-[0.48px]">6 игровых проектов в портфолио</p>
      </div>
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <div className="relative shrink-0 size-[18px]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
  ...
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-[350px]">
      ...
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        ...
        <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Regular',sans-serif] font-normal leading-[18px] min-w-px relative text-[#464a6a] text-[16px] tracking-[0.48px]">6 игровых проектов в портфолио</p>
      </div>
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <div className="relative shrink-0 size-[18px]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
...
function Frame166() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start justify-center relative rounded-[40px] shrink-0 w-full">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Bold',sans-serif] font-bold leading-[20px] relative shrink-0 text-[20px] uppercase">6</p>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[12px] tracking-[0.36px]">
        <p className="leading-[16px] mb-0">игровых проектов</p>
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Medium',sans-serif] font-medium leading-[0] min-w-px relative text-[20px] text-black text-left uppercase">
        <p className="leading-[22px] mb-0">Слышал, что Unreal Engine 5 -</p>
...
export default function UnrealEngineCourseMobile() {
  return (
