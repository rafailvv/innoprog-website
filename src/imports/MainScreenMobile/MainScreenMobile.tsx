...
function Frame147() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[20px] top-[2598px] w-[350px]">
...
function Frame172() {
  return (
    <div className="content-stretch flex flex-col gap-[80px] h-[1262px] items-start relative shrink-0 w-[350px]">
      <Frame157 />
      <Frame177 />
    </div>
  );
...
function Frame122() {
  return (
    <div className="content-stretch flex flex-col font-['Manrope:SemiBold',sans-serif] font-semibold gap-[24px] items-start relative shrink-0 text-[16px] text-white tracking-[0.48px] uppercase w-full">
      ...
      <p className="leading-[22px] relative shrink-0 w-full">
...
function Frame173() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[80px] items-center left-0 top-[3172px] w-[390px]">
      <Frame171 />
      <Frame196 />
      <Frame155 />
      <Frame176 />
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="гланый экран М">
      <div className="absolute bg-[#464a6a] h-[660px] left-0 rounded-bl-[40px] rounded-br-[40px] top-[2432px] w-[390px]" />
      ...
      <Frame194 />
      <div className="absolute bg-[#9c78ff] h-[1731px] left-0 top-[701px] w-[390px]" />
      <Frame145 />
      <Frame147 />
      <Frame173 />
