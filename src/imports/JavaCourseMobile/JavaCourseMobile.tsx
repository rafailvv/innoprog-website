...
function JavaMobileProjectCard({ project, index }: { project: typeof javaMobileProjects[number]; index: number }) {
  return (
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start relative shrink-0 text-white uppercase w-[350px]">
      ...
      <h1 className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[36px] w-full">
        <span className="block leading-[40px]">{`Java `}</span>
...
function Frame237() {
  return (
    <div className="bg-[rgba(255,255,255,0.6)] col-1 content-stretch flex flex-col h-[537px] items-end justify-between ml-0 mt-0 overflow-clip p-[24px] relative rounded-[40px] row-1 w-[350px]">
      <div className="absolute h-[393px] left-[-201px] top-[72px] w-[607px] site-java-hero-image-wrap site-java-hero-image-wrap--mobile" data-name="Иллюстрация чашки Java">
        <img
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[20px] text-center text-white uppercase w-[350px]">
        ...
        <p className="leading-[20px] mb-0">Java-разработку</p>
        <p className="leading-[20px]">Java, Spring Boot, SQL и деплой</p>
      </div>
      <Frame65 />
      <Frame181 />
    </div>
...
function Frame276() {
  return (
    <div className="[word-break:break-word] content-stretch flex font-['Manrope:ExtraBold',sans-serif] font-extrabold items-center justify-between leading-[20px] relative shrink-0 text-[#464a6a] text-[16px] text-center tracking-[0.48px] uppercase w-[350px]">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-[111px]">{`от 111 600 р.`}</p>
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-[114px]">{`от 194 700 р.`}</p>
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-[111px]">{`от 322 600 р.`}</p>
    </div>
  );
}
...
function Frame114() {
  return (
    <div className="content-stretch flex flex-col font-['Manrope:Bold',sans-serif] font-bold gap-[8px] items-start relative shrink-0 w-[131px]">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] leading-[18px] relative shrink-0 w-full">Java-разработчик</p>
...
function Frame87() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start leading-[20px] relative shrink-0 text-black text-right w-[128px]">
      ...
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Bold',sans-serif] font-bold relative shrink-0 text-[14px] uppercase whitespace-nowrap w-full">от 111 600 р.</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
            <span className="leading-[19px]">Настраиваю JDK, Git,</span>
          </li>
        </ul>
      ...
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[21px]">
          <span className="leading-[19px]">Готовлю сборку, README и демонстрацию Java-проекта</span>
        </li>
      </ul>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
      ...
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[21px]">
          <span className="leading-[19px]">Готовлю деплой и production-конфигурацию</span>
        </li>
      </ul>
    </div>
  );
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col font-['Manrope:Regular',sans-serif] font-normal gap-[8px] items-start leading-[0] relative shrink-0 text-[14px] text-black tracking-[0.42px] w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        ...
        <p className="leading-[19px]">для Java-проектов</p>
      </div>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
            <span className="leading-[19px]">Пишу Java-код для</span>
          </li>
        </ul>
        <p className="leading-[19px]">алгоритмов, классов и Java-разработки</p>
      </div>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
      ...
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[21px]">
          <span className="leading-[19px]">Проектирую REST API, DTO, валидацию и обработку ошибок</span>
        </li>
      </ul>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
            <span className="leading-[19px]">Готовлю Java-проект к сборке</span>
          </li>
        </ul>
  ...
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <div className="content-stretch flex gap-[16px] h-[32px] items-center p-[8px] relative rounded-[16px] shrink-0 w-[105px]">
        ...
        <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[18px] relative shrink-0 text-[16px] text-black tracking-[0.48px] whitespace-nowrap">Java</p>
      </div>
      <Frame133 />
      <Frame135 />
    </div>
...
const mobileJavaTechColors: Record<string, string> = {
  Java: "#f89820",
  "Spring Boot": "#6db33f",
  PostgreSQL: "#336791",
  Hibernate: "#59666c",
...
function MobileJavaTechChip({ label }: { label: string; short: string }) {
  return (
    <div className="content-stretch flex gap-[8px] items-center p-[8px] relative rounded-[16px] shrink-0">
      <div aria-hidden className="absolute border border-black border-solid inset-0 pointer-events-none rounded-[16px]" />
  ...
  return (
    <div className="site-course-tech-stack content-stretch flex flex-wrap gap-[8px] items-center justify-center relative shrink-0 w-[350px]">
      <div className="site-course-tech-row relative shrink-0">
        <MobileJavaTechChip label="Java" short="Java" />
        <MobileJavaTechChip label="Spring Boot" short="SB" />
        <MobileJavaTechChip label="PostgreSQL" short="PG" />
      </div>
      <div className="site-course-tech-row relative shrink-0">
      ...
      <div className="site-course-tech-row relative shrink-0">
        <MobileJavaTechChip label="Gradle" short="GR" />
        <MobileJavaTechChip label="Docker" short="DK" />
        <MobileJavaTechChip label="Git" short="Git" />
      </div>
      <div className="site-course-tech-row site-course-tech-row--last relative shrink-0">
        <MobileJavaTechChip label="JUnit" short="JUnit" />
      </div>
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[40px] items-center px-[20px] relative size-full">
          ...
          <Frame192 />
          <CourseSkillList course="java" variant="mobile" />
        </div>
      </div>
    </div>
  );
...
function Frame91() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start leading-[0] relative shrink-0 text-white w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold relative shrink-0 text-[24px] uppercase w-full">
        <p className="leading-[27px] mb-0">15 Java-проектов</p>
...
function Frame71() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-start relative shrink-0 text-black w-full">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[16px] tracking-[0.48px] w-full">
        <p className="leading-[18px] mb-0">Создадите REST API менеджера задач с пользователями, статусами и документацией</p>
...
function Frame77() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-start leading-[0] relative shrink-0 text-black w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold relative shrink-0 text-[24px] uppercase w-full">
        <p className="leading-[27px] mb-0">Spring Boot API</p>
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-start relative shrink-0 text-black w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[0] relative shrink-0 text-[24px] uppercase w-full whitespace-pre-wrap">
        <p className="leading-[27px] mb-0">{`Spring Boot API для `}</p>
...
function Frame79() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-start relative shrink-0 text-black w-full">
      ...
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[18px] relative shrink-0 text-[16px] tracking-[0.48px] w-full">Создадите Spring Boot APIа с каталогом товаров, карточками, корзиной и логикой оформления заказа, который станет удобным инструментом для продаж прямо в мессенджере</p>
    </div>
  );
}
...
function Frame197() {
  return (
    <div className="content-stretch flex gap-[20px] items-start relative shrink-0 w-full site-carousel site-course-projects-carousel" data-carousel="python-mobile-projects">
      {javaMobileProjects.map((project, index) => (
        <JavaMobileProjectCard index={index} key={project.title} project={project} />
      ))}
    </div>
  );
}
...
function Frame99() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(2) Java Core</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[0] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">
        <p className="leading-[20px] mb-0">(3) ООП на Java</p>
...
function Frame105() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(4) Коллекции, исключения и Stream API</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame106() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-pre">{`(5) Git, Maven, Gradle и отладка `}</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame107() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(6) Основы SQL</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame108() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(7) Алгоритмы и структуры данных</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame109() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(8) Web-основы, HTTP, JSON и клиентская часть</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame110() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[0] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">
        <p className="leading-[20px] mb-0">(9) Linux и среда исполнения Java-приложений</p>
        <p className="leading-[20px]">данных</p>
      </div>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
...
function Frame111() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(10) PostgreSQL, JDBC, JPA и Hibernate</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame200() {
  return (
    <div className="content-stretch flex flex-col gap-[80px] items-center relative shrink-0 w-full">
      ...
      <Frame198 />
      <Frame280 />
      <MainScreenMobileTeachersSection preferredRole="Java-разработчик" />
  ...
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-[350px]">
      ...
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        ...
        <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Regular',sans-serif] font-normal leading-[18px] min-w-px relative text-[16px] text-white tracking-[0.48px]">15 Java-проектов в портфолио</p>
      </div>
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <div className="relative shrink-0 size-[18px]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
  ...
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-[350px]">
      ...
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        ...
        <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Regular',sans-serif] font-normal leading-[18px] min-w-px relative text-[#464a6a] text-[16px] tracking-[0.48px]">15 Java-проектов в портфолио</p>
      </div>
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <div className="relative shrink-0 size-[18px]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Medium',sans-serif] font-medium leading-[0] min-w-px relative text-[20px] text-black text-left uppercase">
        <p className="leading-[22px] mb-0">Слышал, что Java -</p>
...
export default function JavaCourseMobile() {
  return (
