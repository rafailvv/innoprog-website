...
import { frontendCourseProgramModules, type CourseProgramModule } from "../courseProgramData";
import { CourseProgramTagIcon } from "../courseProgramIcons";
import { frontendProjectVisualImages } from "../frontendProjectVisualImages";

const projectVisuals = [
  { title: "Frontend portfolio", code: "portfolio-app/" },
  { title: "Product landing", code: "landing-form/" },
  { title: "Media catalog", code: "catalog-app/" },
  { title: "Task manager", code: "task-manager/" },
  { title: "Weather dashboard", code: "weather-dashboard/" },
  { title: "Online shop", code: "shop-cart/" },
  { title: "Booking service", code: "booking-service/" },
  { title: "Admin panel", code: "admin-dashboard/" },
  { title: "Learning platform", code: "education-platform/" },
  { title: "Mini CRM", code: "mini-crm/" },
  { title: "UI kit", code: "ui-kit/" },
  { title: "Chat interface", code: "chat-ui/" },
  { title: "Product analytics dashboard", code: "analytics-dashboard/" },
  { title: "PWA habit tracker", code: "habit-tracker-pwa/" },
  { title: "Student portal", code: "student-portal/" },
];

const frontendProjects = [
  {
    title: "Адаптивный сайт-портфолио frontend-разработчика",
    description:
      "Разработаете многостраничное или SPA-портфолио с проектами, контактной формой, адаптивной сеткой, темной темой и базовой аналитикой действий пользователей",
  },
  {
    title: "Лендинг цифрового продукта с формой заявки",
    description:
      "Создадите промо-страницу с преимуществами, тарифами, отзывами, формой заявки, валидацией, модальным окном и полноценной мобильной адаптацией",
  },
  {
    title: "Интерактивный каталог фильмов или книг",
    description:
      "Соберете каталог с поиском, фильтрами, карточками, избранным, пагинацией и запросами к API или mock-сервису",
  },
  {
    title: "Task manager с авторизационным сценарием",
    description:
      "Создадите приложение для задач с досками, статусами, фильтрацией, формами, локальным или серверным хранением и защищенными маршрутами",
  },
  {
    title: "Погодный dashboard",
    description:
      "Разработаете интерфейс прогноза погоды с выбором города, историей поиска, графиком, обработкой ошибок API и адаптивной визуализацией",
  },
  {
    title: "Интернет-магазин с каталогом и корзиной",
    description:
      "Создадите клиентскую часть магазина с карточками товаров, фильтрами, корзиной, расчетом стоимости, оформлением заказа и сохранением состояния",
  },
  {
    title: "Сервис бронирования услуг",
    description:
      "Разработаете интерфейс выбора услуги, специалиста, даты и времени с формой клиента, проверкой доступности и подтверждением записи",
  },
  {
    title: "Административная панель управления заявками",
    description:
      "Соберете dashboard для списка заявок, статусов, карточки клиента, поиска, фильтров, таблиц, модальных окон и ролей пользователя",
  },
  {
    title: "Образовательная платформа с личным кабинетом",
    description:
      "Разработаете интерфейс курсов, уроков, прогресса, домашних заданий, уведомлений и пользовательского профиля",
  },
  {
    title: "Мини CRM для работы с клиентами",
    description:
      "Создадите SPA-приложение с карточками клиентов, задачами, комментариями, фильтрацией, статусами и историей действий",
  },
  {
    title: "UI-kit и демонстрационное приложение",
    description:
      "Разработаете набор компонентов с документацией, состояниями, дизайн-токенами и демонстрационными страницами",
  },
  {
    title: "Чат-интерфейс для учебного сервиса",
    description:
      "Создадите интерфейс чатов, списка диалогов, сообщений, статусов отправки, поиска, пустых состояний и адаптивной мобильной версии",
  },
  {
    title: "Дашборд аналитики продукта",
    description:
      "Разработаете интерфейс метрик, графиков, фильтров периода, таблиц, карточек показателей и состояний загрузки данных",
  },
  {
    title: "PWA-приложение для личных привычек",
    description:
      "Создадите приложение с трекером привычек, офлайн-режимом, локальным хранением, календарем и уведомительными состояниями",
  },
  {
    title: "Личный кабинет ученика онлайн-школы",
    description:
      "Реализуете веб-кабинет с расписанием занятий, прогрессом по курсу, домашними заданиями, уведомлениями, профилем ученика, API-интеграцией и адаптивной версткой",
  },
];

function ProjectVisual({ index, compact = false }: { index: number; compact?: boolean }) {
  const item = projectVisuals[index] ?? projectVisuals[0];
  const image = frontendProjectVisualImages[index] ?? frontendProjectVisualImages[0];
...
function FrontendProjectCard({ project, index }: { project: typeof frontendProjects[number]; index: number }) {
  return (
...
function Frame165() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[10px] items-start relative shrink-0 text-white uppercase w-[1280px]">
      ...
      <h1 className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Bold',sans-serif] font-bold leading-[97px] relative shrink-0 text-[96px] w-full">Frontend-разработчик</h1>
    </div>
  );
}
    ...
    <div className="bg-[rgba(255,255,255,0.6)] h-[599px] relative rounded-[40px] shrink-0 w-full">
      <div className="flex flex-col items-end justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-end justify-between p-[24px] relative size-full">
          <div className="absolute h-[599px] left-0 top-0 w-[840px]" data-name="Иллюстрация окна с кодом" style={{ mixBlendMode: "color-burn" }}>
            <img
              alt="Окно браузера с символом программного кода"
              className="block contrast-[1.06] h-full max-w-none object-contain pointer-events-none saturate-[1.45] w-full"
              src={imgFrontendHero}
            />
          </div>
          <Frame228 />
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-[628px]">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[0] min-w-full relative shrink-0 text-[40px] text-white uppercase w-[min-content]">
        ...
        <p className="leading-[42px]">анализ данных, React и TypeScript</p>
      </div>
      <Frame76 />
    </div>
  );
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[40px] items-start relative shrink-0 text-black w-full">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Medium',sans-serif] font-medium leading-[41px] relative shrink-0 text-[32px] uppercase w-full">
        Frontend-разработчик создает интерфейсы, SPA-приложения и интеграции с API по данным{" "}
        <a className="site-course-inline-link" href="https://career.hh.ru/profession/40" rel="noopener noreferrer" target="_blank">hh.ru</a>
      </p>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[24px] w-full">
        <p className="leading-[30px] mb-0">На курсе вы проходите полный цикл frontend-разработки: от HTML, CSS и JavaScript до React, API, тестов, доступности и деплоя</p>
        <p className="leading-[30px]">Программа помогает собрать портфолио из проектных работ и подготовиться к первым задачам frontend-разработчика</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-gradient-to-b flex-[1_0_0] from-[rgba(191,167,255,0.6)] h-[162px] min-w-px relative rounded-tl-[30px] rounded-tr-[30px] shadow-[15px_0px_80px_0px_rgba(156,120,255,0.2)] to-[78.365%] to-[rgba(156,120,255,0.8)]">
      <div className="flex flex-col items-center justify-end size-full">
        <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-center justify-end p-[24px] relative size-full text-white uppercase whitespace-nowrap">
          <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[40px]">{`от 79 500 р.`}</p>
...
function Frame256() {
  return (
    <div className="bg-gradient-to-b drop-shadow-[15px_0px_40px_rgba(156,120,255,0.2)] flex-[1_0_0] from-[#ae90ff] h-[342px] min-w-px relative rounded-tl-[30px] rounded-tr-[30px] to-[#8559ff]">
      <div className="flex flex-col items-center justify-end size-full">
        <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-center justify-end p-[24px] relative size-full text-white uppercase whitespace-nowrap">
          <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[40px]">{`от 142 100 р.`}</p>
...
function Frame257() {
  return (
    <div className="bg-gradient-to-b drop-shadow-[15px_0px_40px_rgba(70,74,106,0.2)] flex-[1_0_0] from-[#7f87cd] h-[562px] min-w-px relative rounded-tl-[30px] rounded-tr-[30px] to-[#464a6a]">
      <div className="flex flex-col items-center justify-end size-full">
        <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-center justify-end p-[24px] relative size-full text-white uppercase whitespace-nowrap">
          <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[40px]">{`от 276 700 р.`}</p>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[80px] items-start relative shrink-0 w-full">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[64px] text-black uppercase w-full">
        ...
        <p className="leading-[75px]">Frontend-разработчик</p>
      </div>
      <Frame250 />
    </div>
  );
    ...
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0">
      <div className="bg-[#9c78ff] content-stretch flex flex-col h-[275px] items-end justify-between p-[24px] relative rounded-[32px] shrink-0 w-[302px]">
        ...
        <div className="absolute h-[122px] left-0 overflow-hidden pointer-events-none rounded-tl-[32px] top-0 w-[163px]">
          <img alt="" className="absolute h-[275px] left-0 max-w-none top-0 w-[302px]" src={imgBenefitCard1Figma} />
        </div>
      </div>
...
function Frame127() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[38px] relative shrink-0 text-[#9c78ff] text-[36px] w-full">Frontend-разработчик</p>
...
function Frame98() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 text-right w-[290px]">
      ...
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[#9c78ff] text-[40px] uppercase whitespace-nowrap w-full">от 79 500 р.</p>
    </div>
  );
}
    ...
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-start min-w-px relative">
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Верстаю адаптивные страницы по макетам и дизайн-системам</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Пишу чистый JavaScript и TypeScript для интерфейсной логики</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Создаю React-компоненты и проверяю качество по метрикам</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Работаю с API, состоянием и маршрутизацией</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Интегрирую frontend с API и обрабатываю состояния загрузки и ошибок</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Пишу тесты, проверяю доступность и оптимизирую производительность</span>
        </li>
      </ul>
    </div>
  );
...
function Frame134() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-start min-w-px relative">
      ...
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Настраиваю Vite, линтеры, тесты и деплой</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Собираю и публикую frontend-приложения</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Проверяю качество интерфейсов, компонентов и пользовательских сценариев</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
...
const frontendTechColors: Record<string, string> = {
  HTML5: "#e34f26",
  CSS3: "#1572b6",
  JavaScript: "#f7df1e",
  TypeScript: "#3178c6",
...
function FrontendTechChip({ label }: { label: string; short: string }) {
  return (
...
function Frame136() {
  return (
    <div className="content-stretch flex gap-[16px] items-center p-[8px] relative rounded-[16px] shrink-0">
      ...
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[24px] text-black whitespace-nowrap">React</p>
    </div>
  );
}
...
function MaterialIconThemeStorybook() {
  return (
...
function Frame139() {
  return (
    <div className="content-stretch flex gap-[16px] items-center p-[8px] relative rounded-[16px] shrink-0">
      <div aria-hidden className="absolute border border-black border-solid inset-0 pointer-events-none rounded-[16px]" />
      <MaterialIconThemeStorybook />
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[24px] text-black whitespace-nowrap">pandas</p>
    </div>
  );
}
...
function Frame151() {
  return (
    <div className="content-stretch flex gap-[16px] items-center p-[8px] relative rounded-[16px] shrink-0">
      <div aria-hidden className="absolute border border-black border-solid inset-0 pointer-events-none rounded-[16px]" />
      <DeviconSqlalchemy />
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[24px] text-black whitespace-nowrap">NumPy</p>
    </div>
  );
}
...
function Frame154() {
  return (
    <div className="content-stretch flex gap-[8px] items-end relative shrink-0">
      <FrontendTechChip label="HTML5" short="H5" />
      <FrontendTechChip label="CSS3" short="CSS" />
      <FrontendTechChip label="JavaScript" short="JS" />
      <FrontendTechChip label="TypeScript" short="TS" />
      <FrontendTechChip label="React" short="R" />
      <FrontendTechChip label="Vite" short="V" />
    </div>
  );
}
...
function Frame145() {
  return (
    <div className="content-stretch flex gap-[16px] items-center p-[8px] relative rounded-[16px] shrink-0">
      ...
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[24px] text-black w-[92px]">Vite</p>
    </div>
  );
}
...
function MaterialIconThemeStorybook1() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="material-icon-theme:django">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="material-icon-theme:django">
...
function Frame142() {
  return (
    <div className="content-stretch flex gap-[16px] items-center p-[8px] relative rounded-[16px] shrink-0">
      <div aria-hidden className="absolute border border-black border-solid inset-0 pointer-events-none rounded-[16px]" />
      <MaterialIconThemeStorybook1 />
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[24px] text-black whitespace-nowrap">scikit-learn</p>
    </div>
  );
}
...
function Frame148() {
  return (
    <div className="content-stretch flex gap-[16px] items-center p-[8px] relative rounded-[16px] shrink-0">
      <div aria-hidden className="absolute border border-black border-solid inset-0 pointer-events-none rounded-[16px]" />
      <DeviconFastapi />
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[24px] text-black whitespace-nowrap">TypeScript</p>
    </div>
  );
}
...
function Frame155() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full">
      <FrontendTechChip label="Node.js" short="N" />
      <FrontendTechChip label="Git" short="Git" />
      <FrontendTechChip label="Tailwind CSS" short="TW" />
      <FrontendTechChip label="Figma" short="F" />
      <FrontendTechChip label="Storybook" short="SB" />
      <FrontendTechChip label="Testing Library" short="TL" />
    </div>
  );
}
...
function Frame156() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
      <FrontendTechChip label="Playwright" short="PW" />
      <FrontendTechChip label="REST API" short="API" />
      <FrontendTechChip label="VS Code" short="VS" />
    </div>
  );
}
...
function Frame158() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-start relative shrink-0 w-full">
      <Frame135 />
      <CourseSkillList course="frontend" variant="desktop" />
    </div>
  );
}
      ...
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[24px] items-center p-[24px] relative size-full">
          ...
          <div className="aspect-[800/450] overflow-hidden relative rounded-[24px] shrink-0 w-full" data-name="image 46">
            <img alt="Индивидуальное занятие с наставником ИННОПРОГ" title="Индивидуальное занятие с наставником ИННОПРОГ" decoding="async" loading="lazy" className="absolute inset-0 max-w-none object-contain pointer-events-none size-full" src={imgImage46} />
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[24px] items-start relative shrink-0 text-white w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Medium',sans-serif] font-medium leading-[0] relative shrink-0 text-[40px] uppercase w-full whitespace-pre-wrap">
        <p className="leading-[44px] mb-0">{`15 проектных работ `}</p>
      ...
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[24px] items-center p-[24px] relative size-full">
          ...
          <div className="aspect-[3024/1790] overflow-hidden relative rounded-[24px] shrink-0 w-full" data-name="3">
            <img alt="Пример проектной работы на курсе ИННОПРОГ" title="Пример проектной работы на курсе ИННОПРОГ" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgRectangle40094} />
          </div>
        </div>
      </div>
    </div>
        ...
        <div className="content-stretch flex flex-col gap-[24px] items-start justify-center p-[24px] relative size-full">
          ...
          <div className="h-[617px] overflow-hidden relative rounded-[24px] shrink-0 w-full">
            <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[inherit]">
              <img alt="Личный чат с наставником ИННОПРОГ" title="Личный чат с наставником ИННОПРОГ" className="absolute h-full left-[0.15%] max-w-none top-0 w-[99.73%]" src={imgRectangle40093} />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[24px] items-center p-[24px] relative size-full">
          ...
          <div className="h-[427px] overflow-hidden relative rounded-[24px] shrink-0 w-full">
            <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[inherit]">
              <img alt="Платформа-тренажер ИННОПРОГ для практических заданий" title="Платформа-тренажер ИННОПРОГ для практических заданий" className="absolute h-[98.49%] left-0 max-w-none top-[0.17%] w-full" src={imgRectangle40095} />
            </div>
          </div>
        </div>
      </div>
...
function Frame92() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start relative shrink-0 text-black w-full">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Bold',sans-serif] font-bold leading-[33px] relative shrink-0 text-[32px] uppercase w-full">Storybook-приложение интернет-магазина</p>
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start leading-[0] relative shrink-0 text-black w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Bold',sans-serif] font-bold relative shrink-0 text-[32px] uppercase w-full">
        ...
        <p className="leading-[33px]">на React</p>
      </div>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal relative shrink-0 text-[20px] w-full">
        <p className="leading-[22px] mb-0">Разработаете полноценный веб-проект</p>
        <p className="leading-[22px] mb-0">с React, TypeScript, фильтрами, корзиной, API, тестами и деплоем</p>
  ...
  return (
    <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full site-carousel site-course-projects-carousel" data-carousel="python-projects">
      {frontendProjects.map((project, index) => (
        <FrontendProjectCard index={index} key={project.title} project={project} />
      ))}
    </div>
  );
}
...
function Frame113() {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center p-[16px] relative rounded-[32px] shrink-0">
      <div aria-hidden className="absolute border border-solid border-white inset-0 pointer-events-none rounded-[32px]" />
      <GrommetIconsTask />
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[27px] relative shrink-0 text-[20px] text-white whitespace-nowrap">15 проектных работ</p>
    </div>
  );
}
...
function Frame111() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">(1) Введение в профессию Frontend-разработчик</p>
...
function Frame112() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">{`(2) HTML, CSS и адаптивная верстка `}</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame117() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">{`(3) JavaScript и TypeScript `}</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame118() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">(4) Git и командная разработка</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame119() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">{`(5) Инструменты разработки и Linux `}</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame120() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">(6) React и компонентная архитектура</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame121() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">(7) Маршрутизация, состояние и API</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame122() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">(8) Тестирование и доступность</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame123() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">(9) Дизайн-системы и UI-kit</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[0] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">
        ...
        <span className="leading-[53px]">Storybook</span>
      </p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
...
function Frame110() {
  ...
  return (
    <div className="site-course-program-list site-course-program-list--desktop">
      {frontendCourseProgramModules.map((module, index) => (
    ...
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0 w-full site-carousel site-teachers-carousel site-course-teachers-carousel" data-carousel="python-teachers" data-carousel-loop="true" tabIndex={0}>
      ...
      <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-[302px]" data-name="Данила Дробышев">
        <div className="h-[324px] relative rounded-[32px] shrink-0 w-full">
          <div aria-hidden className="absolute inset-0 pointer-events-none rounded-[32px]">
            ...
            <img alt="Преподаватель Данила Дробышев" title="Преподаватель Данила Дробышев" className="absolute max-w-none object-bottom rounded-[32px] size-full" src={imgRectangle40083} />
          </div>
        </div>
        <Frame46 />
      </div>
      <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-[302px]" data-name="Григорий Чепель">
        <div className="h-[324px] relative rounded-[32px] shrink-0 w-full">
          <div aria-hidden className="absolute inset-0 pointer-events-none rounded-[32px]">
            <div className="absolute inset-0 rounded-[32px]" style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\'0 0 302 324\\' xmlns=\\'http://www.w3.org/2000/svg\\' preserveAspectRatio=\\'none\\'><rect x=\\'0\\' y=\\'0\\' height=\\'100%\\' width=\\'100%\\' fill=\\'url(%23grad)\\' opacity=\\'1\\'/><defs><radialGradient id=\\'grad\\' gradientUnits=\\'userSpaceOnUse\\' cx=\\'0\\' cy=\\'0\\' r=\\'10\\' gradientTransform=\\'matrix(9.2461e-16 16.2 -15.1 9.9196e-16 151 162)\\'><stop stop-color=\\'rgba(151,71,255,0)\\' offset=\\'0\\'/><stop stop-color=\\'rgba(151,71,255,1)\\' offset=\\'1\\'/></radialGradient></defs></svg>')" }} />
            <div className="absolute inset-0 overflow-hidden rounded-[32px]">
              <img alt="Преподаватель Григорий Чепель" title="Преподаватель Григорий Чепель" className="absolute h-[107.41%] left-[-7.76%] max-w-none top-[-1.29%] w-[115.23%]" src={imgRectangle40084} />
            </div>
          </div>
        </div>
        <Frame47 />
      ...
      <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-[302px]" data-name="Алан Агузаров">
        <div className="h-[324px] relative rounded-[32px] shrink-0 w-full">
          <div aria-hidden className="absolute inset-0 pointer-events-none rounded-[32px]">
            <div className="absolute inset-0 rounded-[32px]" style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\'0 0 302 324\\' xmlns=\\'http://www.w3.org/2000/svg\\' preserveAspectRatio=\\'none\\'><rect x=\\'0\\' y=\\'0\\' height=\\'100%\\' width=\\'100%\\' fill=\\'url(%23grad)\\' opacity=\\'1\\'/><defs><radialGradient id=\\'grad\\' gradientUnits=\\'userSpaceOnUse\\' cx=\\'0\\' cy=\\'0\\' r=\\'10\\' gradientTransform=\\'matrix(9.2461e-16 16.2 -15.1 9.9196e-16 151 162)\\'><stop stop-color=\\'rgba(151,71,255,0)\\' offset=\\'0\\'/><stop stop-color=\\'rgba(151,71,255,1)\\' offset=\\'1\\'/></radialGradient></defs></svg>')" }} />
            <img alt="Преподаватель Алан Агузаров" title="Преподаватель Алан Агузаров" className="absolute max-w-none object-bottom rounded-[32px] size-full" src={imgRectangle40085} />
          </div>
        </div>
        <Frame48 />
      </div>
      <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-[302px]" data-name="Павел Мягчилов">
        <div className="h-[324px] relative rounded-[32px] shrink-0 w-full">
          <div aria-hidden className="absolute inset-0 pointer-events-none rounded-[32px]">
            <div className="absolute inset-0 rounded-[32px]" style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\'0 0 302 324\\' xmlns=\\'http://www.w3.org/2000/svg\\' preserveAspectRatio=\\'none\\'><rect x=\\'0\\' y=\\'0\\' height=\\'100%\\' width=\\'100%\\' fill=\\'url(%23grad)\\' opacity=\\'1\\'/><defs><radialGradient id=\\'grad\\' gradientUnits=\\'userSpaceOnUse\\' cx=\\'0\\' cy=\\'0\\' r=\\'10\\' gradientTransform=\\'matrix(9.2461e-16 16.2 -15.1 9.9196e-16 151 162)\\'><stop stop-color=\\'rgba(151,71,255,0)\\' offset=\\'0\\'/><stop stop-color=\\'rgba(151,71,255,1)\\' offset=\\'1\\'/></radialGradient></defs></svg>')" }} />
            <div className="absolute inset-0 overflow-hidden rounded-[32px]">
              <img alt="Преподаватель Павел Мягчилов" title="Преподаватель Павел Мягчилов" className="absolute h-[134.96%] left-0 max-w-none top-[-13.66%] w-full" src={imgRectangle40086} />
            </div>
          </div>
        </div>
        <Frame49 />
      ...
      <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-[302px]" data-name="Джамбулат Таджидинов">
        <div className="h-[324px] relative rounded-[32px] shrink-0 w-full">
          <div aria-hidden className="absolute inset-0 pointer-events-none rounded-[32px]">
            <div className="absolute inset-0 rounded-[32px]" style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\'0 0 302 324\\' xmlns=\\'http://www.w3.org/2000/svg\\' preserveAspectRatio=\\'none\\'><rect x=\\'0\\' y=\\'0\\' height=\\'100%\\' width=\\'100%\\' fill=\\'url(%23grad)\\' opacity=\\'1\\'/><defs><radialGradient id=\\'grad\\' gradientUnits=\\'userSpaceOnUse\\' cx=\\'0\\' cy=\\'0\\' r=\\'10\\' gradientTransform=\\'matrix(9.2461e-16 16.2 -15.1 9.9196e-16 151 162)\\'><stop stop-color=\\'rgba(151,71,255,0)\\' offset=\\'0\\'/><stop stop-color=\\'rgba(151,71,255,1)\\' offset=\\'1\\'/></radialGradient></defs></svg>')" }} />
            <div className="absolute inset-0 overflow-hidden rounded-[32px]">
              <img alt="Преподаватель Джамбулат Таджидинов" title="Преподаватель Джамбулат Таджидинов" className="absolute h-[124.27%] left-[0.11%] max-w-none top-[-14.44%] w-[99.89%]" src={imgRectangle40087} />
            </div>
          </div>
        </div>
        <Frame50 />
...
function CourseTeachersCarouselBlock() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-center relative shrink-0 w-full">
      <DesktopTeacherCarousel carouselId="python-teachers" course preferredRole="Frontend-разработчик" />
...
function Frame186() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start justify-center relative shrink-0 w-full">
      ...
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <WeuiDone2Filled2 />
        <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Regular',sans-serif] font-normal leading-[22px] min-w-px relative text-[20px] text-white">15 проектных работ в портфолио</p>
      </div>
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <WeuiDone2Filled3 />
...
function Frame187() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start justify-center relative shrink-0 w-full">
      ...
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <WeuiDone2Filled9 />
        <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Regular',sans-serif] font-normal leading-[22px] min-w-px relative text-[#464a6a] text-[20px]">15 проектных работ в портфолио</p>
      </div>
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <WeuiDone2Filled10 />
...
function Frame199() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start justify-center px-[20px] py-[16px] relative shrink-0">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[40px] uppercase">40</p>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[32px]">
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-w-px relative">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Raleway:Medium',sans-serif] font-medium leading-[0] min-w-px relative text-[40px] text-black text-left uppercase">
        <p className="leading-[53px] mb-0">Слышал, что frontend - это только верстка</p>
...
export default function FrontendCourseDesktop() {
  return (
