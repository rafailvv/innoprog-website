...
import { mobileDeveloperCourseProgramModules, type CourseProgramModule } from "../courseProgramData";
import { CourseProgramTagIcon } from "../courseProgramIcons";
import { mobileDeveloperProjectVisualImages } from "../mobileDeveloperProjectVisualImages";
import { MainScreenMobileTeachersSection } from "../MainScreenMobile/MainScreenMobile";

const mobileProjectVisuals = [
  { title: "Mobile task manager", code: "mobile-task-manager/" },
  { title: "Habit tracker", code: "habit-tracker/" },
  { title: "Product catalog", code: "product-catalog/" },
  { title: "Weather app", code: "weather-app/" },
  { title: "Personal finance", code: "personal-finance/" },
  { title: "Table booking", code: "table-booking/" },
  { title: "Service booking", code: "service-booking/" },
  { title: "Small business CRM", code: "mobile-crm/" },
  { title: "Delivery map", code: "delivery-map/" },
  { title: "Mobile shop", code: "mobile-shop/" },
  { title: "News app", code: "news-app/" },
  { title: "Fitness tracker", code: "fitness-tracker/" },
  { title: "Synced notes", code: "synced-notes/" },
  { title: "Auth profile app", code: "auth-profile-app/" },
  { title: "Study planner app", code: "study-planner-app/" },
];

const mobileDeveloperMobileProjects = [
  {
    title: "Мобильный менеджер задач",
    description:
      "Создадите приложение для создания, редактирования, фильтрации и закрытия задач с локальным хранением и удобным экраном списка",
  },
  {
    title: "Трекер привычек и целей",
    description:
      "Разработаете приложение для ежедневных отметок, статистики прогресса, напоминаний и визуализации результатов пользователя",
  },
  {
    title: "Каталог товаров с избранным",
    description:
      "Соберете мобильный каталог с карточками товаров, поиском, фильтрацией, избранным и сохранением выбранных позиций",
  },
  {
    title: "Мобильное приложение прогноза погоды",
    description:
      "Подключите внешнее API, отобразите текущую погоду, прогноз, состояния загрузки, ошибки и успешного результата",
  },
  {
    title: "Приложение личных финансов",
    description:
      "Создадите систему учета доходов и расходов, категорий, периода, сводки и локального хранения финансовых записей",
  },
  {
    title: "Приложение для бронирования столиков",
    description:
      "Разработаете мобильный интерфейс выбора даты, времени, количества гостей, контактных данных и статуса заявки на бронирование",
  },
  {
    title: "Приложение записи на услуги",
    description:
      "Соберете сервис выбора специалиста, услуги, даты, времени, подтверждения записи и отображения истории посещений",
  },
  {
    title: "Учебная CRM для малого бизнеса",
    description:
      "Реализуете приложение с клиентами, заказами, статусами, заметками, поиском и локальной базой данных",
  },
  {
    title: "Приложение доставки с картой",
    description:
      "Создадите приложение для отображения заказов, маршрутов, геолокации, статуса доставки и карточки заказа",
  },
  {
    title: "Мобильный интернет-магазин",
    description:
      "Разработаете приложение с каталогом, карточкой товара, корзиной, оформлением заказа, авторизацией и API-интеграцией",
  },
  {
    title: "Новостное приложение",
    description:
      "Соберете приложение для чтения ленты новостей из API, поиска, сохранения статей и offline-доступа к избранному",
  },
  {
    title: "Фитнес-трекер тренировок",
    description:
      "Создадите приложение для расписания тренировок, упражнений, подходов, прогресса и уведомлений",
  },
  {
    title: "Приложение для заметок с синхронизацией",
    description:
      "Разработаете заметки с тегами, поиском, локальным кешем и синхронизацией с backend-сервисом",
  },
  {
    title: "Приложение с авторизацией и личным кабинетом",
    description:
      "Соберете мобильный проект с регистрацией, входом, защищенными экранами, профилем пользователя и обработкой ошибок API",
  },
  {
    title: "Мобильный планировщик обучения",
    description:
      "Создадите Flutter-приложение с расписанием занятий, задачами, прогрессом по курсу, push-состояниями, локальным хранением, API-синхронизацией и релизной сборкой",
  },
];

function MobileProjectVisual({ index }: { index: number }) {
  const item = mobileProjectVisuals[index] ?? mobileProjectVisuals[0];
  const image = mobileDeveloperProjectVisualImages[index] ?? mobileDeveloperProjectVisualImages[0];
...
function MobileDeveloperMobileProjectCard({ project, index }: { project: typeof mobileDeveloperMobileProjects[number]; index: number }) {
  return (
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start relative shrink-0 text-white uppercase w-[350px]">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[40px] w-full">
        <p className="leading-[43px] mb-0">Flutter</p>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[20px] text-center text-white uppercase w-[350px]">
        ...
        <p className="leading-[20px] mb-0">мобильную разработку</p>
        <p className="leading-[20px]">Dart, Flutter, API и публикацию</p>
      </div>
      <Frame65 />
      <Frame181 />
    </div>
...
function Frame276() {
  return (
    <div className="[word-break:break-word] content-stretch flex font-['Manrope:ExtraBold',sans-serif] font-extrabold items-center justify-between leading-[20px] relative shrink-0 text-[#464a6a] text-[16px] text-center tracking-[0.48px] uppercase w-[350px]">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-[111px]">{`от 94 400 ₽`}</p>
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-[114px]">{`от 152 800 ₽`}</p>
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-[111px]">{`от 280 000 ₽`}</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-start relative shrink-0 w-full">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[0] relative shrink-0 text-[32px] text-black uppercase w-full">
        <p className="leading-[32px] mb-0">Уровень дохода мобильного разработчика</p>
        <p className="leading-[32px]">
          по данным{" "}
          <a className="site-course-inline-link" href="https://career.hh.ru/profession/52" rel="noopener noreferrer" target="_blank">hh.ru</a>
        </p>
      </div>
      <Frame277 />
    </div>
...
function Frame114() {
  return (
    <div className="content-stretch flex flex-col font-['Manrope:Bold',sans-serif] font-bold gap-[8px] items-start relative shrink-0 w-[131px]">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] leading-[18px] relative shrink-0 w-full">Мобильный разработчик</p>
...
function Frame87() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start leading-[20px] relative shrink-0 text-black text-right w-[128px]">
      ...
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Bold',sans-serif] font-bold relative shrink-0 text-[14px] uppercase whitespace-nowrap w-full">от 94 400 ₽</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
            <span className="leading-[19px]">Настраиваю Flutter CLI, Git,</span>
          </li>
        </ul>
        <p className="leading-[19px]">тесты, отладку и сборку приложения</p>
      </div>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[21px]">
          <span className="leading-[19px]">Готовлю сборку, README и демонстрацию мобильного проекта</span>
        </li>
      </ul>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
            <span className="leading-[19px]">Проверяю сценарии и дефекты через</span>
          </li>
        </ul>
        <p className="leading-[19px]">тесты и отладку</p>
      </div>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[21px]">
          <span className="leading-[19px]">Готовлю релизные сборки и публикацию приложения</span>
        </li>
      </ul>
    </div>
  );
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col font-['Manrope:Regular',sans-serif] font-normal gap-[8px] items-start leading-[0] relative shrink-0 text-[14px] text-black tracking-[0.42px] w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
            <span className="leading-[19px]">Реализую алгоритмы</span>
          </li>
        </ul>
        <p className="leading-[19px]">для мобильных проектов</p>
      </div>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
            <span className="leading-[19px]">Пишу Flutter код для</span>
          </li>
        </ul>
        <p className="leading-[19px]">алгоритмов, классов и мобильной разработки</p>
      </div>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
            <span className="leading-[19px]">Отлаживаю программы и проверяю</span>
          </li>
        </ul>
      ...
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[21px]">
          <span className="leading-[19px]">Подключаю API, JSON, HTTP и авторизацию</span>
        </li>
      </ul>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
            <span className="leading-[19px]">Готовлю мобильный проект к сборке</span>
          </li>
        </ul>
  ...
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <div className="content-stretch flex gap-[16px] h-[32px] items-center p-[8px] relative rounded-[16px] shrink-0 w-[105px]">
        ...
        <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[18px] relative shrink-0 text-[16px] text-black tracking-[0.48px] whitespace-nowrap">Flutter</p>
      </div>
      <Frame133 />
      <Frame135 />
    </div>
...
function Frame129() {
  return (
    <div className="content-stretch flex gap-[8px] items-center p-[8px] relative rounded-[16px] shrink-0">
      ...
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[18px] relative shrink-0 text-[16px] text-black tracking-[0.48px] whitespace-nowrap">Многопоточность</p>
    </div>
  );
}
...
const mobileMobileDeveloperTechColors: Record<string, string> = {
  Dart: "#0175c2",
  Flutter: "#02569b",
  Android: "#3ddc84",
  iOS: "#111827",
...
function MobileMobileDeveloperTechChip({ label, short }: { label: string; short: string }) {
  const color = mobileMobileDeveloperTechColors[label] || "#9c78ff";
  ...
  return (
    <div className="site-course-tech-stack content-stretch flex flex-wrap gap-[8px] items-center justify-center relative shrink-0 w-[350px]">
      <div className="site-course-tech-row relative shrink-0">
        <MobileMobileDeveloperTechChip label="Dart" short="Dart" />
        <MobileMobileDeveloperTechChip label="Flutter" short="FL" />
        <MobileMobileDeveloperTechChip label="Android" short="AN" />
      </div>
      <div className="site-course-tech-row relative shrink-0">
        <MobileMobileDeveloperTechChip label="iOS" short="iOS" />
        <MobileMobileDeveloperTechChip label="REST API" short="API" />
        <MobileMobileDeveloperTechChip label="JSON" short="JSON" />
      </div>
      <div className="site-course-tech-row relative shrink-0">
        <MobileMobileDeveloperTechChip label="SQLite" short="SQL" />
        <MobileMobileDeveloperTechChip label="Firebase" short="FB" />
        <MobileMobileDeveloperTechChip label="Git" short="Git" />
      </div>
      <div className="site-course-tech-row site-course-tech-row--last relative shrink-0">
        <MobileMobileDeveloperTechChip label="Flutter tests" short="TEST" />
      </div>
    </div>
  );
}
...
function Frame91() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start leading-[0] relative shrink-0 text-white w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold relative shrink-0 text-[24px] uppercase w-full">
        <p className="leading-[27px] mb-0">15 мобильных проектов</p>
...
function Frame80() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-start relative shrink-0 text-black w-full">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[27px] relative shrink-0 text-[24px] uppercase w-full">(10) Проектная практика-приложение интернет-магазина</p>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[16px] tracking-[0.48px] w-full">
...
function Frame82() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-start leading-[0] relative shrink-0 text-black w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold relative shrink-0 text-[24px] uppercase w-full">
        <p className="leading-[27px] mb-0">Мобильный планировщик</p>
        <p className="leading-[27px]">обучения</p>
      </div>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal relative shrink-0 text-[16px] tracking-[0.48px] w-full">
        <p className="leading-[18px] mb-0">Создадите Flutter-приложение с расписанием занятий, задачами</p>
        <p className="leading-[18px] mb-0">прогрессом по курсу, push-состояниями и локальным хранением</p>
        <p className="leading-[18px]">API-синхронизацией и релизной сборкой</p>
      </div>
    </div>
  );
}
...
function Frame197() {
  return (
    <div className="content-stretch flex gap-[20px] items-start relative shrink-0 w-full site-carousel site-course-projects-carousel" data-carousel="python-mobile-projects">
      {mobileDeveloperMobileProjects.map((project, index) => (
        <MobileDeveloperMobileProjectCard index={index} key={project.title} project={project} />
      ))}
    </div>
  );
}
...
function Frame99() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(2) Основы Dart и алгоритмизация</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame105() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(4) Git и инструменты мобильного разработчика</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame106() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-pre">{`(5) SQL и моделирование данных приложений  `}</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame107() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(6) Flutter UI, виджеты и адаптивная верстка</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame108() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(7) Навигация, состояние и архитектура Flutter</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame109() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(8) API, JSON, HTTP и backend-интеграции</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame201() {
  ...
  return (
    <div className="site-course-program-list site-course-program-list--mobile">
      {mobileDeveloperCourseProgramModules.map((module, index) => (
  ...
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-[350px]">
      ...
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        ...
        <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Regular',sans-serif] font-normal leading-[18px] min-w-px relative text-[16px] text-white tracking-[0.48px]">15 мобильных проектов в портфолио</p>
      </div>
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <div className="relative shrink-0 size-[18px]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
  ...
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-[350px]">
      ...
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        ...
        <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Regular',sans-serif] font-normal leading-[18px] min-w-px relative text-[#464a6a] text-[16px] tracking-[0.48px]">15 мобильных проектов в портфолио</p>
      </div>
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <div className="relative shrink-0 size-[18px]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
...
function Frame166() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start justify-center relative rounded-[40px] shrink-0 w-full">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[12px] tracking-[0.36px]">
        <p className="leading-[16px] mb-0">мобильных проектов</p>
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Medium',sans-serif] font-medium leading-[0] min-w-px relative text-[20px] text-black text-left uppercase">
        <p className="leading-[22px] mb-0">Слышал, что Flutter -</p>
        <p className="leading-[22px] mb-0">это только алгоритмы</p>
        <p className="leading-[22px]">{`что я буду учить на курсе? `}</p>
      </div>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
...
export default function MobileDeveloperCourseMobile() {
  return (
