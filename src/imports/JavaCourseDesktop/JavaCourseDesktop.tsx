...
import imgJavaHero from "../shared/course-heroes/java-coffee-cup.webp";
...
import { javaCourseProgramModules, type CourseProgramModule } from "../courseProgramData";
import { CourseProgramTagIcon } from "../courseProgramIcons";
import { javaProjectVisualImages } from "../javaProjectVisualImages";

const projectVisuals = [
  { title: "Task manager", code: "java-task-manager/" },
  { title: "Warehouse inventory", code: "warehouse-inventory/" },
  { title: "Employees payroll", code: "employees-payroll/" },
...
const javaProjects = [
  {
    title: "Консольный менеджер задач на Java",
    description:
      "Создадите приложение для создания, редактирования, поиска, фильтрации и закрытия задач с хранением данных в файле или базе данных",
  },
  {
    title: "Система учета товаров на складе",
    description:
      "Разработаете сервис для номенклатуры, остатков, цен, поступлений, списаний и отчета по доступным позициям",
  },
  {
    title: "База сотрудников и зарплат",
    description:
      "Соберете приложение для хранения сотрудников, расчета начислений, поиска, сортировки и управленческого отчета",
  },
  {
    title: "Сервис бронирования поездок",
    description:
      "Создадите систему учета клиентов, автомобилей, маршрутов, времени поездки и статуса бронирования",
  },
  {
    title: "Сервис управления пассажирскими перевозками",
    description:
      "Разработаете приложение для учета транспорта, вместимости, пассажиров, посадки, свободных мест и истории рейсов",
  },
  {
    title: "Key-Value хранилище на дереве поиска",
    description:
      "Реализуете собственную структуру хранения с добавлением, поиском, обновлением, удалением и обходом данных",
  },
  {
  ...
  },
  {
    ...
    description:
      "Разработаете backend-сервис с задачами, пользователями, статусами, валидацией, обработкой ошибок и документацией API",
  },
  {
    title: "Сервис учета заказов с PostgreSQL",
    description:
      "Создадите Spring Boot-приложение с товарами, заказами, клиентами, транзакциями, миграциями и интеграционными тестами",
  },
  {
    title: "Интернет-магазин на Spring Boot",
    description:
      "Соберете web/backend-проект с каталогом, корзиной, заказами, ролями пользователей, административной частью и PostgreSQL",
  },
  {
    title: "Сервис авторизации и личного кабинета",
    description:
...
function ProjectVisual({ index, compact = false }: { index: number; compact?: boolean }) {
  ...
  const image = javaProjectVisualImages[index] ?? javaProjectVisualImages[0];
...
function JavaProjectCard({ project, index }: { project: typeof javaProjects[number]; index: number }) {
  return (
...
function Frame165() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[10px] items-start relative shrink-0 text-white uppercase w-[1280px]">
      ...
      <h1 className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Bold',sans-serif] font-bold leading-[97px] relative shrink-0 text-[96px] w-full">Java-разработчик</h1>
    </div>
  );
}
    ...
    <div className="bg-[rgba(255,255,255,0.6)] h-[599px] relative rounded-[40px] shrink-0 w-full">
      <div className="flex flex-col items-end justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-end justify-between p-[24px] relative size-full">
          <div className="absolute h-[599px] left-0 top-0 w-[925px] site-java-hero-image-wrap site-java-hero-image-wrap--desktop" data-name="Иллюстрация чашки Java">
            <img
              alt="Фиолетовая чашка с паром для курса Java-разработчик"
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-[628px]">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[0] min-w-full relative shrink-0 text-[40px] text-white uppercase w-[min-content]">
        ...
        <p className="leading-[42px]">Java, Spring Boot, SQL и backend</p>
      </div>
      <Frame76 />
    </div>
  );
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[40px] items-start relative shrink-0 text-black w-full">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Medium',sans-serif] font-medium leading-[41px] relative shrink-0 text-[32px] uppercase w-full">
        Java-разработчик создает прикладные программы, desktop-клиенты и backend-сервисы, проектирует объектные модели, REST API, базы данных и тесты по данным{" "}
    ...
    <div className="bg-gradient-to-b flex-[1_0_0] from-[rgba(191,167,255,0.6)] h-[162px] min-w-px relative rounded-tl-[30px] rounded-tr-[30px] shadow-[15px_0px_80px_0px_rgba(156,120,255,0.2)] to-[78.365%] to-[rgba(156,120,255,0.8)]">
      <div className="flex flex-col items-center justify-end size-full">
        <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-center justify-end p-[24px] relative size-full text-white uppercase whitespace-nowrap">
          <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[40px]">{`от 111 600 р.`}</p>
...
function Frame256() {
  return (
    <div className="bg-gradient-to-b drop-shadow-[15px_0px_40px_rgba(156,120,255,0.2)] flex-[1_0_0] from-[#ae90ff] h-[342px] min-w-px relative rounded-tl-[30px] rounded-tr-[30px] to-[#8559ff]">
      <div className="flex flex-col items-center justify-end size-full">
        <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-center justify-end p-[24px] relative size-full text-white uppercase whitespace-nowrap">
          <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[40px]">{`от 194 700 р.`}</p>
...
function Frame257() {
  return (
    <div className="bg-gradient-to-b drop-shadow-[15px_0px_40px_rgba(70,74,106,0.2)] flex-[1_0_0] from-[#7f87cd] h-[562px] min-w-px relative rounded-tl-[30px] rounded-tr-[30px] to-[#464a6a]">
      <div className="flex flex-col items-center justify-end size-full">
        <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-center justify-end p-[24px] relative size-full text-white uppercase whitespace-nowrap">
          <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[40px]">{`от 322 600 р.`}</p>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[80px] items-start relative shrink-0 w-full">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[64px] text-black uppercase w-full">
        ...
        <p className="leading-[75px]">Java-разработчик</p>
      </div>
      <Frame250 />
    </div>
  );
...
function Frame127() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[38px] relative shrink-0 text-[#9c78ff] text-[36px] w-full">Java-разработчик</p>
...
function Frame98() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 text-right w-[290px]">
      ...
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[#9c78ff] text-[40px] uppercase whitespace-nowrap w-full">от 111 600 р.</p>
    </div>
  );
}
    ...
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-start min-w-px relative">
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Пишу Java-код и проектирую объектные модели</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Разрабатываю консольные и JavaFX-приложения</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Проектирую слои приложения, сервисы и репозитории</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Проектирую REST API, DTO, валидацию и обработку ошибок</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Интегрирую PostgreSQL, JDBC, JPA и Hibernate</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Пишу JUnit/Mockito-тесты и проверяю качество backend-сервиса</span>
        </li>
      </ul>
    </div>
  );
...
function Frame134() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-start min-w-px relative">
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Использую Git, Maven, Gradle, Docker и Linux</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Отлаживаю Java-приложения и читаю stacktrace</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Готовлю сборку, README и демонстрацию Java-проекта</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Пишу unit и интеграционные тесты</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Готовлю деплой и production-конфигурацию</span>
        </li>
      </ul>
    </div>
  );
...
const javaTechColors: Record<string, string> = {
  Java: "#f89820",
  "Spring Boot": "#6db33f",
  PostgreSQL: "#336791",
  Hibernate: "#59666c",
...
function JavaTechChip({ label }: { label: string; short: string }) {
  return (
...
function Frame154() {
  return (
    <div className="content-stretch flex gap-[8px] items-end relative shrink-0">
      <JavaTechChip label="Java" short="Java" />
...
function Frame155() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full">
      <JavaTechChip label="Gradle" short="GR" />
      <JavaTechChip label="Git" short="Git" />
      <JavaTechChip label="ООП" short="OOP" />
      <JavaTechChip label="Алгоритмы" short="ALG" />
      <JavaTechChip label="JUnit" short="JUnit" />
      <JavaTechChip label="Отладка" short="DBG" />
    </div>
  );
}
...
function Frame156() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
      <JavaTechChip label="Docker" short="DK" />
      <JavaTechChip label="SQL" short="SQL" />
      <JavaTechChip label="Linux" short="Linux" />
    </div>
  );
}
...
function Frame158() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-start relative shrink-0 w-full">
      <Frame135 />
      <CourseSkillList course="java" variant="desktop" />
    </div>
  );
}
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[24px] items-start relative shrink-0 text-white w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Medium',sans-serif] font-medium leading-[0] relative shrink-0 text-[40px] uppercase w-full whitespace-pre-wrap">
        <p className="leading-[44px] mb-0">{`15 Java-проектов `}</p>
...
function Frame82() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start relative shrink-0 text-black w-full">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[20px] w-full">
        <p className="leading-[22px] mb-0">Создадите Spring Boot APIа, с помощью</p>
...
function Frame89() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start leading-[0] relative shrink-0 text-black w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Bold',sans-serif] font-bold relative shrink-0 text-[32px] uppercase w-full">
        <p className="leading-[33px] mb-0">Spring Boot API</p>
...
function Frame90() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start relative shrink-0 text-black w-full">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Bold',sans-serif] font-bold leading-[33px] relative shrink-0 text-[32px] uppercase w-full">REST API менеджера задач на Spring Boot</p>
...
function Frame91() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start relative shrink-0 text-black w-full">
      ...
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[20px] w-full">Создадите Spring Boot APIа с каталогом товаров, карточками, корзиной и логикой оформления заказа, который станет удобным инструментом для продаж прямо в мессенджере</p>
    </div>
  );
}
...
function Frame92() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start relative shrink-0 text-black w-full">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Bold',sans-serif] font-bold leading-[33px] relative shrink-0 text-[32px] uppercase w-full">(15) Backend сервиса бронирования занятий</p>
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[20px] w-full">Разработаете Spring Boot API для записи на занятия: расписание, свободные слоты, бронирования, роли пользователей, PostgreSQL, миграции, тесты и Docker-запуск</p>
    </div>
  );
}
...
function Frame99() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start leading-[0] relative shrink-0 text-black w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Bold',sans-serif] font-bold relative shrink-0 text-[32px] uppercase w-full">
        <p className="leading-[33px] mb-0">Backend сервиса</p>
        <p className="leading-[33px]">бронирования занятий</p>
      </div>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal relative shrink-0 text-[20px] w-full">
        <p className="leading-[22px] mb-0">Разработаете Spring Boot API для записи на занятия:</p>
        <p className="leading-[22px] mb-0">расписание, свободные слоты, бронирования, роли пользователей</p>
        <p className="leading-[22px]">PostgreSQL, миграции, тесты и Docker-запуск</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full site-carousel site-course-projects-carousel" data-carousel="python-projects">
      {javaProjects.map((project, index) => (
        <JavaProjectCard index={index} key={project.title} project={project} />
      ))}
    </div>
  );
}
...
function Frame113() {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center p-[16px] relative rounded-[32px] shrink-0">
      <div aria-hidden className="absolute border border-solid border-white inset-0 pointer-events-none rounded-[32px]" />
      <GrommetIconsTask />
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[27px] relative shrink-0 text-[20px] text-white whitespace-nowrap">15 Java-проектов</p>
    </div>
  );
}
...
function Frame112() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">{`(2) Java Core `}</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame117() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">{`(3) Объектно-ориентированное программирование на Java `}</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame118() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">(4) Коллекции, исключения и Stream API</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame119() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">{`(5) Git, Maven, Gradle и отладка`}</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame120() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">(6) Основы SQL</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame121() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">(7) Алгоритмы и структуры данных</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame122() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">(8) Web-основы, HTTP, JSON и клиентская часть</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame123() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">(9) Linux и среда исполнения Java-приложений</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[0] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">
        ...
        <span className="leading-[53px]">Spring Boot API</span>
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[0] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">
        ...
        <span className="leading-[53px]">Spring Boot: REST API, безопасность и деплой</span>
      </p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
...
function Frame110() {
  ...
  return (
    <div className="site-course-program-list site-course-program-list--desktop">
      {javaCourseProgramModules.map((module, index) => (
...
function CourseTeachersCarouselBlock() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-center relative shrink-0 w-full">
      <DesktopTeacherCarousel carouselId="python-teachers" course preferredRole="Java-разработчик" />
...
function Frame186() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start justify-center relative shrink-0 w-full">
      ...
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <WeuiDone2Filled2 />
        <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Regular',sans-serif] font-normal leading-[22px] min-w-px relative text-[20px] text-white">15 Java-проектов в портфолио</p>
      </div>
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <WeuiDone2Filled3 />
...
function Frame187() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start justify-center relative shrink-0 w-full">
      ...
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <WeuiDone2Filled9 />
        <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Regular',sans-serif] font-normal leading-[22px] min-w-px relative text-[#464a6a] text-[20px]">15 Java-проектов в портфолио</p>
      </div>
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <WeuiDone2Filled10 />
...
function Frame198() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start justify-center px-[20px] py-[16px] relative shrink-0">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[32px]">
        <p className="leading-[30px] mb-0 whitespace-pre">{`Java-проектов `}</p>
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-w-px relative">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Raleway:Medium',sans-serif] font-medium leading-[0] min-w-px relative text-[40px] text-black text-left uppercase">
        <p className="leading-[53px] mb-0">Слышал, что Java - это слишком сложно</p>
...
export default function JavaCourseDesktop() {
  return (
