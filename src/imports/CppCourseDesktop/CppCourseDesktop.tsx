...
import { cppCourseProgramModules, type CourseProgramModule } from "../courseProgramData";
import { CourseProgramTagIcon } from "../courseProgramIcons";
import { cppProjectVisualImages } from "../cppProjectVisualImages";

const projectVisuals = [
  { title: "Task manager", code: "task-manager/" },
  { title: "Warehouse inventory", code: "warehouse-inventory/" },
  { title: "Payroll database", code: "payroll-database/" },
  { title: "Trip booking", code: "trip-booking/" },
  { title: "Passenger transport", code: "passenger-transport/" },
  { title: "Key-value storage", code: "key-value-tree/" },
  { title: "Log analyzer", code: "log-analyzer/" },
  { title: "Text indexer", code: "text-indexer/" },
  { title: "Graph route planner", code: "graph-routes/" },
  { title: "Media catalog", code: "media-catalog/" },
  { title: "Console shop", code: "console-shop/" },
  { title: "PostgreSQL request tracker", code: "postgres-request-tracker/" },
  { title: "Multithreaded file processor", code: "threaded-file-processor/" },
  { title: "C++ library", code: "cpp-library/" },
  { title: "Log analytics engine", code: "log-analytics-engine/" },
];
...
const cppProjects = [
  {
    ...
    description:
      "Разработаете приложение для создания, редактирования, поиска, сортировки и закрытия задач с сохранением данных в файл",
  },
  {
    title: "Система учета товаров на складе",
    description:
      "Соберете учет позиций, остатков, цен, приходов и списаний, а также сформируете отчет по состоянию склада",
  },
  {
    title: "База зарплат сотрудников",
    description:
      "Реализуете хранение сотрудников, должностей, ставок и премий, расчет выплат и поиск записей по параметрам",
  },
  {
    title: "Сервис бронирования поездок",
    description:
      "Спроектируете модель клиентов, транспорта, маршрутов и заявок с проверкой доступности и расчетом стоимости поездки",
  },
  {
    title: "Система управления пассажирскими перевозками",
    description:
      "Создадите учет вместимости, посадки пассажиров, свободных мест и отчетов по рейсам",
  },
  {
    title: "Key-value хранилище на дереве поиска",
    description:
      "Реализуете добавление, поиск, обновление, удаление записей и обходы дерева с понятной структурой данных",
  },
  {
    title: "Анализатор логов",
    description:
      "Разберете текстовые файлы, посчитаете события, найдете ошибки, сгруппируете записи по времени и подготовите отчет",
  },
  {
    title: "Индексатор текстовых документов",
    description:
      "Построите обратный индекс, поиск по словам, простое ранжирование результатов и сохранение индекса",
  },
  {
    title: "Графовый планировщик маршрутов",
    description:
      "Представите маршруты в виде графа, реализуете поиск пути, расчет расстояний и сравнение алгоритмов",
  },
  {
    title: "Каталог книг или медиатеки",
    description:
      "Создадите ООП-приложение с сущностями, фильтрами, сортировками, сохранением данных и отчетами",
  },
  {
    title: "Магазин с каталогом и корзиной в консоли",
    description:
      "Реализуете каталог, корзину, расчет стоимости, оформление заказа и проверку наличия товаров",
  },
  {
    title: "Приложение с PostgreSQL для учета заявок",
    description:
      "Соберете C++ приложение с подключением к базе, CRUD-операциями, SQL-скриптами и тестами",
  },
  {
    title: "Многопоточный обработчик файлов",
    description:
      "Организуете параллельную обработку набора файлов, сбор статистики, синхронизацию потоков и итоговый отчет",
  },
  {
    title: "Учебная библиотека C++ с CMake и unit-тестами",
    description:
      "Разработаете самостоятельный модуль с публичным API, тестами, документацией и примером использования",
  },
  {
    title: "Система анализа логов сервера",
    description:
      "Разработаете консольное C++ приложение для чтения больших log-файлов, поиска ошибок, подсчета статистики, фильтрации событий, экспорта отчета и покрытия тестами",
  },
];

function ProjectVisual({ index, compact = false }: { index: number; compact?: boolean }) {
  const item = projectVisuals[index] ?? projectVisuals[0];
  const image = cppProjectVisualImages[index] ?? cppProjectVisualImages[0];
...
function CppProjectCard({ project, index }: { project: typeof cppProjects[number]; index: number }) {
  return (
...
function Frame165() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[10px] items-start relative shrink-0 text-white uppercase w-[1280px]">
      ...
      <h1 className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Bold',sans-serif] font-bold leading-[97px] relative shrink-0 text-[96px] w-full">C++ разработчик</h1>
    </div>
  );
}
    ...
    <div className="bg-[rgba(255,255,255,0.6)] h-[599px] relative rounded-[40px] shrink-0 w-full">
      <div className="flex flex-col items-end justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-end justify-between p-[24px] relative size-full">
          <div className="absolute h-[599px] left-0 top-0 w-[909px]" data-name="Иллюстрация процессора C++">
            <img
              alt="Процессор с символом языка программирования C++"
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-[628px]">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[0] min-w-full relative shrink-0 text-[40px] text-white uppercase w-[min-content]">
        ...
        <p className="leading-[42px]">C++, алгоритмы, CMake и Linux</p>
      </div>
      <Frame76 />
    </div>
  );
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[40px] items-start relative shrink-0 text-black w-full">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Medium',sans-serif] font-medium leading-[41px] relative shrink-0 text-[32px] uppercase w-full">
        C++ разработчик создает прикладные и системные программы, работает с алгоритмами, памятью, архитектурой и базами данных по данным{" "}
        <a className="site-course-inline-link" href="https://career.hh.ru/profession/56" rel="noopener noreferrer" target="_blank">hh.ru</a>
      </p>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[24px] w-full">
        <p className="leading-[30px] mb-0">На курсе вы проходите полный цикл C++ разработки: основы языка, алгоритмы, современный C++, ООП, CMake, SQL, Linux и тестирование</p>
        <p className="leading-[30px]">Программа помогает собрать портфолио из проектных работ и подготовиться к первым задачам C++ разработчика</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-gradient-to-b flex-[1_0_0] from-[rgba(191,167,255,0.6)] h-[162px] min-w-px relative rounded-tl-[30px] rounded-tr-[30px] shadow-[15px_0px_80px_0px_rgba(156,120,255,0.2)] to-[78.365%] to-[rgba(156,120,255,0.8)]">
      <div className="flex flex-col items-center justify-end size-full">
        <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-center justify-end p-[24px] relative size-full text-white uppercase whitespace-nowrap">
          <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[40px]">{`от 149 700 р.`}</p>
...
function Frame256() {
  return (
    <div className="bg-gradient-to-b drop-shadow-[15px_0px_40px_rgba(156,120,255,0.2)] flex-[1_0_0] from-[#ae90ff] h-[342px] min-w-px relative rounded-tl-[30px] rounded-tr-[30px] to-[#8559ff]">
      <div className="flex flex-col items-center justify-end size-full">
        <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-center justify-end p-[24px] relative size-full text-white uppercase whitespace-nowrap">
          <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[40px]">{`от 206 800 р.`}</p>
...
function Frame257() {
  return (
    <div className="bg-gradient-to-b drop-shadow-[15px_0px_40px_rgba(70,74,106,0.2)] flex-[1_0_0] from-[#7f87cd] h-[562px] min-w-px relative rounded-tl-[30px] rounded-tr-[30px] to-[#464a6a]">
      <div className="flex flex-col items-center justify-end size-full">
        <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-center justify-end p-[24px] relative size-full text-white uppercase whitespace-nowrap">
          <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[40px]">{`от 309 700 р.`}</p>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[80px] items-start relative shrink-0 w-full">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[64px] text-black uppercase w-full">
        ...
        <p className="leading-[75px]">C++ разработчик</p>
      </div>
      <Frame250 />
    </div>
  );
...
function Frame127() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[38px] relative shrink-0 text-[#9c78ff] text-[36px] w-full">C++ разработчик</p>
...
function Frame98() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 text-right w-[290px]">
      ...
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[#9c78ff] text-[40px] uppercase whitespace-nowrap w-full">от 149 700 р.</p>
    </div>
  );
}
    ...
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-start min-w-px relative">
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Реализую алгоритмы и структуры данных на C++</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Пишу C++ код, который собирается и решает прикладные задачи</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Проектирую классы и проверяю качество C++ кода</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Подключаю PostgreSQL и работаю с SQL-данными</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Проектирую классы, модули и архитектуру C++ приложений</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Проверяю качество кода и безопасность обработки данных</span>
        </li>
      </ul>
    </div>
  );
...
function Frame134() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-start min-w-px relative">
      ...
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Использую отладчик, санитайзеры и code review</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Настраиваю CMake, Git и воспроизводимую сборку</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Пишу unit-тесты, отлаживаю и исправляю дефекты</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
...
const cppTechColors: Record<string, string> = {
  "C++": "#00599c",
  CMake: "#064f8c",
  STL: "#6b46c1",
  Git: "#f05032",
...
function CppTechChip({ label }: { label: string; short: string }) {
  return (
...
function Frame154() {
  return (
    <div className="content-stretch flex gap-[8px] items-end relative shrink-0">
      <CppTechChip label="C++" short="C++" />
      <CppTechChip label="CMake" short="CM" />
      <CppTechChip label="STL" short="STL" />
      <CppTechChip label="Git" short="Git" />
      <CppTechChip label="Linux" short="LX" />
      <CppTechChip label="PostgreSQL" short="PG" />
    </div>
  );
}
...
function Frame155() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full">
      <CppTechChip label="Unit tests" short="UT" />
      <CppTechChip label="ООП" short="OOP" />
      <CppTechChip label="Алгоритмы" short="ALG" />
      <CppTechChip label="(10) Проектная практика" short="M" />
      <CppTechChip label="Отладка" short="DBG" />
    </div>
  );
}
...
function Frame156() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
      <CppTechChip label="Санитайзеры" short="SAN" />
      <CppTechChip label="SQL" short="SQL" />
      <CppTechChip label="Bash" short="SH" />
    </div>
  );
}
...
function Frame158() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-start relative shrink-0 w-full">
      <Frame135 />
      <CourseSkillList course="cpp" variant="desktop" />
    </div>
  );
}
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[24px] items-start relative shrink-0 text-white w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Medium',sans-serif] font-medium leading-[0] relative shrink-0 text-[40px] uppercase w-full whitespace-pre-wrap">
        <p className="leading-[44px] mb-0">{`15 C++ проектов `}</p>
...
function Frame92() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start relative shrink-0 text-black w-full">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Bold',sans-serif] font-bold leading-[33px] relative shrink-0 text-[32px] uppercase w-full">(10) Проектная практика-приложение интернет-магазина</p>
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start leading-[0] relative shrink-0 text-black w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Bold',sans-serif] font-bold relative shrink-0 text-[32px] uppercase w-full">
        ...
        <p className="leading-[33px]">для бизнеса</p>
      </div>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal relative shrink-0 text-[20px] w-full">
        <p className="leading-[22px] mb-0">Разработаете полноценный веб-проект</p>
        <p className="leading-[22px] mb-0">с CMake, тестами, архитектурой, README и инструкцией запуска</p>
  ...
  return (
    <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full site-carousel site-course-projects-carousel" data-carousel="python-projects">
      {cppProjects.map((project, index) => (
        <CppProjectCard index={index} key={project.title} project={project} />
      ))}
    </div>
  );
}
...
function Frame113() {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center p-[16px] relative rounded-[32px] shrink-0">
      <div aria-hidden className="absolute border border-solid border-white inset-0 pointer-events-none rounded-[32px]" />
      <GrommetIconsTask />
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[27px] relative shrink-0 text-[20px] text-white whitespace-nowrap">15 C++ проектов</p>
    </div>
  );
}
...
function Frame111() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">(1) Вводный организационно-методический модуль</p>
...
function Frame112() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">{`(2) Основы программирования на C++ `}</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame117() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">{`(3) Алгоритмы и структуры данных на C++ `}</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame118() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">(4) Современный C++ и стандартная библиотека</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame119() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">{`(5) ООП и архитектура C++ приложений `}</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame120() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">(6) Git, CMake и отладка</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame121() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">(7) SQL и PostgreSQL для C++</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame122() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">(8) Linux и эксплуатация C++ приложений</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame123() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">(9) Тестирование и качество C++</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame110() {
  ...
  return (
    <div className="site-course-program-list site-course-program-list--desktop">
      {cppCourseProgramModules.map((module, index) => (
...
function CourseTeachersCarouselBlock() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-center relative shrink-0 w-full">
      <DesktopTeacherCarousel carouselId="python-teachers" course preferredRole="C++ разработчик" />
...
function Frame186() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start justify-center relative shrink-0 w-full">
      ...
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <WeuiDone2Filled2 />
        <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Regular',sans-serif] font-normal leading-[22px] min-w-px relative text-[20px] text-white">15 C++ проектов в портфолио</p>
      </div>
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <WeuiDone2Filled3 />
...
function Frame187() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start justify-center relative shrink-0 w-full">
      ...
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <WeuiDone2Filled9 />
        <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Regular',sans-serif] font-normal leading-[22px] min-w-px relative text-[#464a6a] text-[20px]">15 C++ проектов в портфолио</p>
      </div>
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <WeuiDone2Filled10 />
...
function Frame198() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start justify-center px-[20px] py-[16px] relative shrink-0">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[32px]">
        <p className="leading-[30px] mb-0 whitespace-pre">{`C++ проектов `}</p>
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-w-px relative">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Raleway:Medium',sans-serif] font-medium leading-[0] min-w-px relative text-[40px] text-black text-left uppercase">
        <p className="leading-[53px] mb-0">Слышал, что C++ - это слишком сложно</p>
...
export default function CppCourseDesktop() {
  return (
