...
const dataAnalystMobileProjects = [
  {
    title: "Аналитика продаж",
    description: "Построите SQL-выгрузку, рассчитаете выручку, средний чек, динамику продаж и подготовите Python-отчет с графиками и бизнес-выводами",
  },
  {
    title: "Дашборд операционных показателей",
    description: "Соберете интерактивный BI-дашборд по ключевым операционным метрикам, фильтрам, отклонениям и зонам внимания для руководителя",
  },
  {
    title: "RFM-сегментация клиентов",
    description: "Разделите клиентов на сегменты по давности, частоте и сумме покупок, опишите поведение групп и предложите действия для удержания",
  },
  {
    title: "Анализ воронки регистрации",
    description: "Посчитаете конверсии между шагами, найдете точки потерь, сравните сегменты пользователей и оформите рекомендации по улучшению воронки",
  },
  {
    title: "Когортный анализ удержания",
    description: "Построите когорты пользователей, рассчитаете retention, визуализируете динамику и покажете, какие группы возвращаются лучше",
  },
  {
    title: "Оценка A/B-теста новой гипотезы",
    description: "Проверите корректность эксперимента, рассчитаете статистическую значимость, доверительные интервалы и подготовите решение по запуску",
  },
  {
    title: "Финансовая аналитика",
    description: "Проанализируете доходы, расходы, маржинальность и динамику финансовых показателей, соберете отчет для принятия управленческих решений",
  },
  {
    title: "HR-аналитика текучести",
    description: "Исследуете факторы увольнений, сравните отделы и стаж сотрудников, визуализируете риски и подготовите рекомендации для HR-команды",
  },
  {
    title: "Аналитика службы поддержки",
    description: "Посчитаете нагрузку, время ответа, категории обращений, тональность и качество обработки заявок, соберете понятный отчет для руководителя",
  },
  {
    title: "Маркетинговая аналитика",
    description: "Оцените каналы привлечения, стоимость лида, конверсии и окупаемость кампаний, чтобы определить сильные и слабые источники трафика",
  },
  {
    title: "Складская аналитика остатков",
    description: "Проанализируете остатки, оборачиваемость, дефицит и излишки, подготовите витрину данных и рекомендации по управлению запасами",
  },
  {
    title: "Аудит качества данных",
    description: "Проведете диагностику датасета, найдете пропуски, дубликаты, выбросы и ошибки типов, оформите отчет с правилами исправления",
  },
  {
    title: "BI-дашборд для руководителя",
    description: "Спроектируете executive-дашборд с KPI, фильтрами, динамикой, детализацией и пояснениями, чтобы руководитель видел состояние бизнеса",
  },
  {
    title: "Анализ пользовательского поведения",
    description: "Исследуете события пользователей, частоту действий, пути внутри продукта и проблемные места, которые мешают достижению целевого действия",
  },
  {
    title: "Аналитика выручки подписочного сервиса",
    description: "Построите аналитику MRR, churn, retention и LTV для подписочного продукта: подготовите SQL-витрину, Python-анализ, BI-дашборд и рекомендации по росту выручки",
  },
];
...
function DataAnalystMobileProjectCard({ project, index }: { project: typeof dataAnalystMobileProjects[number]; index: number }) {
  return (
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start relative shrink-0 text-white uppercase w-[350px]">
      ...
      <h1 className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[40px] w-full">
        <span className="block leading-[43px]">Data-</span>
        <span className="block leading-[43px]">аналитик</span>
      </h1>
    </div>
  );
}
...
function Frame237() {
  return (
    <div className="bg-[rgba(255,255,255,0.6)] col-1 content-stretch flex flex-col h-[537px] items-end justify-between ml-0 mt-0 overflow-clip p-[24px] relative rounded-[40px] row-1 w-[350px]">
      <div className="absolute h-[393px] left-[-160px] top-[72px] w-[616px]" data-name="Иллюстрация аналитической панели">
        <img
...
function Frame276() {
  return (
    <div className="[word-break:break-word] content-stretch flex font-['Manrope:ExtraBold',sans-serif] font-extrabold items-center justify-between leading-[20px] relative shrink-0 text-[#464a6a] text-[16px] text-center tracking-[0.48px] uppercase w-[350px]">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-[111px]">{`от 81 200 р.`}</p>
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-[114px]">{`от 108 600 р.`}</p>
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-[111px]">{`от 243 100 р.`}</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-start relative shrink-0 w-full">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[0] relative shrink-0 text-[32px] text-black uppercase w-full">
        <p className="leading-[32px] mb-0">Уровень дохода Data-аналитика</p>
...
function Frame114() {
  return (
    <div className="content-stretch flex flex-col font-['Manrope:Bold',sans-serif] font-bold gap-[8px] items-start relative shrink-0 w-[131px]">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] leading-[18px] relative shrink-0 w-full">Data-аналитик</p>
...
function Frame87() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start leading-[20px] relative shrink-0 text-black text-right w-[128px]">
      ...
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Bold',sans-serif] font-bold relative shrink-0 text-[14px] uppercase whitespace-nowrap w-full">от 81 200 р.</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
            <span className="leading-[19px]">Настраиваю NumPy, линтеры,</span>
          </li>
        </ul>
        <p className="leading-[19px]">качество данных и публикацию отчета</p>
      </div>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[21px]">
          <span className="leading-[19px]">Собираю аналитические отчеты</span>
        </li>
      </ul>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
        ...
        <p className="leading-[19px]">Статистика и A/B-тесты</p>
      </div>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[21px]">
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col font-['Manrope:Regular',sans-serif] font-normal gap-[8px] items-start leading-[0] relative shrink-0 text-[14px] text-black tracking-[0.42px] w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        ...
        <p className="leading-[19px]">для аналитических отчетов</p>
      </div>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
            <span className="leading-[19px]">Пишу SQL и Python для</span>
          </li>
        </ul>
        <p className="leading-[19px]">метрик, витрин и аналитики данных</p>
      </div>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
            <span className="leading-[19px]">Строю дашборды и проверяю</span>
          </li>
        </ul>
      ...
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[21px]">
          <span className="leading-[19px]">Проектирую витрины данных и словари метрик</span>
        </li>
      </ul>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] relative shrink-0 w-full">
        <ul className="mb-0">
          <li className="list-disc ms-[21px]">
            <span className="leading-[19px]">Готовлю данные для дашбордов</span>
          </li>
        </ul>
...
function Frame123() {
  return (
    <div className="content-stretch flex gap-[8px] items-center p-[8px] relative rounded-[16px] shrink-0">
      ...
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[18px] relative shrink-0 text-[16px] text-black tracking-[0.48px] whitespace-nowrap">BI</p>
    </div>
  );
}
...
function Frame134() {
  return (
    <div className="content-stretch flex gap-[8px] items-center p-[8px] relative rounded-[16px] shrink-0">
      <div aria-hidden className="absolute border border-black border-solid inset-0 pointer-events-none rounded-[16px]" />
      <DeviconVscode />
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[18px] relative shrink-0 text-[16px] text-black tracking-[0.48px] whitespace-nowrap">Excel</p>
    </div>
  );
}
...
const mobileDataAnalystTechColors: Record<string, string> = {
  SQL: "#e34f26",
  PostgreSQL: "#1572b6",
  Python: "#f7df1e",
  pandas: "#3178c6",
...
function MobileDataAnalystTechChip({ label }: { label: string; short: string }) {
  return (
    <div className="content-stretch flex gap-[8px] items-center p-[8px] relative rounded-[16px] shrink-0">
      <div aria-hidden className="absolute border border-black border-solid inset-0 pointer-events-none rounded-[16px]" />
  ...
  return (
    <div className="site-course-tech-stack content-stretch flex flex-wrap gap-[8px] items-center justify-center relative shrink-0 w-[350px]">
      <div className="site-course-tech-row relative shrink-0">
        <MobileDataAnalystTechChip label="SQL" short="SQL" />
        <MobileDataAnalystTechChip label="PostgreSQL" short="PG" />
        <MobileDataAnalystTechChip label="Python" short="Py" />
      </div>
      <div className="site-course-tech-row relative shrink-0">
        <MobileDataAnalystTechChip label="pandas" short="pd" />
        <MobileDataAnalystTechChip label="BI" short="BI" />
        <MobileDataAnalystTechChip label="NumPy" short="np" />
      </div>
      <div className="site-course-tech-row relative shrink-0">
        <MobileDataAnalystTechChip label="Jupyter" short="J" />
        <MobileDataAnalystTechChip label="Git" short="Git" />
        <MobileDataAnalystTechChip label="Power BI" short="PBI" />
      </div>
      <div className="site-course-tech-row relative shrink-0">
        <MobileDataAnalystTechChip label="Tableau" short="T" />
        <MobileDataAnalystTechChip label="Metabase" short="M" />
      </div>
      <div className="site-course-tech-row relative shrink-0">
        <MobileDataAnalystTechChip label="Статистика" short="Stat" />
        <MobileDataAnalystTechChip label="A/B-тесты" short="A/B" />
      </div>
      <div className="site-course-tech-row site-course-tech-row--last relative shrink-0">
        <MobileDataAnalystTechChip label="REST API" short="API" />
        <MobileDataAnalystTechChip label="Excel" short="XLS" />
      </div>
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[40px] items-center px-[20px] relative size-full">
          ...
          <Frame192 />
          <CourseSkillList course="dataAnalyst" variant="mobile" />
        </div>
      </div>
    </div>
  );
...
function Frame91() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start leading-[0] relative shrink-0 text-white w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold relative shrink-0 text-[24px] uppercase w-full">
        <p className="leading-[27px] mb-0">15 аналитических проектов</p>
...
function Frame80() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-start relative shrink-0 text-black w-full">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[27px] relative shrink-0 text-[24px] uppercase w-full">Metabase-приложение интернет-магазина</p>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[16px] tracking-[0.48px] w-full">
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-start leading-[0] relative shrink-0 text-black w-full">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal relative shrink-0 text-[16px] tracking-[0.48px] w-full">
        ...
        <p className="leading-[18px] mb-0">с SQL, Python, BI-дашбордом, проверкой данных и презентацией</p>
...
function Frame197() {
  return (
    <div className="content-stretch flex gap-[20px] items-start relative shrink-0 w-full site-carousel site-course-projects-carousel" data-carousel="python-mobile-projects">
      {dataAnalystMobileProjects.map((project, index) => (
        <DataAnalystMobileProjectCard index={index} key={project.title} project={project} />
      ))}
    </div>
  );
}
...
function Frame99() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(2) Основы SQL и реляционных баз данных</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame105() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(4) Data Engineering и витрины данных</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame106() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-pre">{`(5) Статистика и проверка гипотез  `}</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame107() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(6) BI, визуализация и дашборды</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame108() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(7) Продуктовая и бизнес-аналитика</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame109() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[16px] text-left text-white tracking-[0.48px] uppercase whitespace-nowrap">(8) A/B-тестирование</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-1.3%_-2.61%_-1.3%_0]">
...
function Frame200() {
  return (
    <div className="content-stretch flex flex-col gap-[80px] items-center relative shrink-0 w-full">
      ...
      <Frame198 />
      <Frame280 />
      <MainScreenMobileTeachersSection preferredRole="Data-аналитик" />
  ...
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-[350px]">
      ...
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        ...
        <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Regular',sans-serif] font-normal leading-[18px] min-w-px relative text-[16px] text-white tracking-[0.48px]">15 аналитических проектов в портфолио</p>
      </div>
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <div className="relative shrink-0 size-[18px]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
  ...
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-[350px]">
      ...
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        ...
        <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Regular',sans-serif] font-normal leading-[18px] min-w-px relative text-[#464a6a] text-[16px] tracking-[0.48px]">15 аналитических проектов в портфолио</p>
      </div>
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <div className="relative shrink-0 size-[18px]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
...
function Frame166() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start justify-center relative rounded-[40px] shrink-0 w-full">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[12px] tracking-[0.36px]">
        <p className="leading-[16px] mb-0">аналитических проектов</p>
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Medium',sans-serif] font-medium leading-[0] min-w-px relative text-[20px] text-black text-left uppercase">
        <p className="leading-[22px] mb-0">Слышал, что аналитика -</p>
...
export default function DataAnalystCourseMobile() {
  return (
