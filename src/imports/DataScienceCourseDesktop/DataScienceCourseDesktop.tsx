...
import imgDataScienceHero from "./data-science-hero-2x.png";
...
const dataScienceProjects = [
  {
    ...
    description:
      "Соберете отчет по продажам: очистите данные, найдете провалы и точки роста, рассчитаете выручку, средний чек, повторные покупки и подготовите выводы для бизнеса",
  },
  {
    title: "SQL-витрина клиентских транзакций",
    description:
      "Спроектируете витрину в PostgreSQL: объедините заказы, клиентов и платежи, примените оконные функции, посчитаете RFM-показатели и подготовите данные для аналитики",
  },
  {
    title: "Аудит качества данных перед моделированием",
    description:
      "Проведете диагностику датасета: найдете пропуски, дубли, выбросы, утечки и перекосы выборки, а затем оформите понятный data quality report",
  },
  {
    title: "A/B-тест продуктовой гипотезы",
    description:
      "Разберете эксперимент как продуктовый аналитик: выберете метрики, проверите корректность групп, оцените статистическую значимость и сформулируете решение по запуску",
  },
  {
    title: "Дашборд продуктовых и бизнес-метрик",
    description:
      "Соберете управленческий дашборд с выручкой, конверсией, retention и сегментами пользователей, чтобы команда могла быстро видеть состояние продукта",
  },
  {
    title: "Модель прогнозирования спроса",
    description:
      "Построите модель, которая прогнозирует спрос по истории продаж, сезонности, акциям и внешним факторам, сравните baseline и ML-подход и разберете ошибки прогноза",
  },
  {
    title: "Скоринг заявок и лидов",
    description:
      "Обучите модель, которая оценивает вероятность целевого действия: подготовите признаки, сравните ROC AUC и F1, настроите порог и объясните важные факторы",
  },
  {
    title: "Сегментация клиентской базы",
    description:
      "Разделите клиентов на поведенческие группы, опишете профиль каждого сегмента и предложите персональные сценарии коммуникации, продаж или удержания",
  },
  {
    title: "Прогноз выручки по временным рядам",
    description:
      "Соберете прогноз по дневной или недельной выручке: учтете тренд, сезонность и лаги, проведете backtesting и оцените качество на будущих периодах",
  },
  {
    title: "NLP-система анализа обращений",
    description:
      "Создадите классификатор обращений или отзывов: очистите тексты, выделите темы и тональность, обучите модель и покажете, какие проблемы чаще всего волнуют клиентов",
  },
  {
    title: "CV-прототип контроля качества",
    description:
      "Соберете прототип компьютерного зрения для классификации изображений: примените transfer learning, оцените качество и опишете ограничения данных и модели",
  },
  {
    title: "ML-сервис с API и Docker",
    description:
      "Превратите модель в сервис: сохраните артефакты, обернете инференс в FastAPI, добавите Docker, логирование, тестовый запрос и инструкцию запуска",
  },
  {
    title: "Система прогнозирования оттока клиентов",
    description:
      "Соберете прикладную систему удержания: обучите модель риска оттока, объясните причины ухода клиентов и подготовите список действий для менеджеров или CRM-кампаний",
  },
];
...
function DataScienceProjectCard({ project, index }: { project: typeof dataScienceProjects[number]; index: number }) {
  return (
...
function Frame165() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[10px] items-start relative shrink-0 text-white uppercase w-[1280px]">
      ...
      <h1 className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Bold',sans-serif] font-bold leading-[97px] relative shrink-0 text-[96px] w-full">Data Science</h1>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-[628px]">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[0] min-w-full relative shrink-0 text-[40px] text-white uppercase w-[min-content]">
        ...
        <p className="leading-[42px]">анализ данных, ML и Python</p>
      </div>
      <Frame76 />
    </div>
  );
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[40px] items-start relative shrink-0 text-black w-full">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Medium',sans-serif] font-medium leading-[41px] relative shrink-0 text-[32px] uppercase w-full">
        Data Science объединяет аналитику данных, Python, SQL и машинное обучение по данным{" "}
        <a className="site-course-inline-link" href="https://career.hh.ru/profession/1" rel="noopener noreferrer" target="_blank">hh.ru</a>
      </p>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[24px] w-full">
        <p className="leading-[30px] mb-0">На курсе вы проходите полный цикл работы с данными: сбор, очистку, исследование, статистику, обучение моделей и подготовку результата для бизнеса</p>
        <p className="leading-[30px]">Программа помогает собрать портфолио из проектных работ и подготовиться к первым задачам специалиста в области Data Science</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-gradient-to-b flex-[1_0_0] from-[rgba(191,167,255,0.6)] h-[162px] min-w-px relative rounded-tl-[30px] rounded-tr-[30px] shadow-[15px_0px_80px_0px_rgba(156,120,255,0.2)] to-[78.365%] to-[rgba(156,120,255,0.8)]">
      <div className="flex flex-col items-center justify-end size-full">
        <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-center justify-end p-[24px] relative size-full text-white uppercase whitespace-nowrap">
          <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[40px]">{`от 108 700 р.`}</p>
...
function Frame256() {
  return (
    <div className="bg-gradient-to-b drop-shadow-[15px_0px_40px_rgba(156,120,255,0.2)] flex-[1_0_0] from-[#ae90ff] h-[342px] min-w-px relative rounded-tl-[30px] rounded-tr-[30px] to-[#8559ff]">
      <div className="flex flex-col items-center justify-end size-full">
        <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-center justify-end p-[24px] relative size-full text-white uppercase whitespace-nowrap">
          <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[40px]">{`от 200 500 р.`}</p>
...
function Frame257() {
  return (
    <div className="bg-gradient-to-b drop-shadow-[15px_0px_40px_rgba(70,74,106,0.2)] flex-[1_0_0] from-[#7f87cd] h-[562px] min-w-px relative rounded-tl-[30px] rounded-tr-[30px] to-[#464a6a]">
      <div className="flex flex-col items-center justify-end size-full">
        <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-center justify-end p-[24px] relative size-full text-white uppercase whitespace-nowrap">
          <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[40px]">{`от 396 700 р.`}</p>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[80px] items-start relative shrink-0 w-full">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[64px] text-black uppercase w-full">
        ...
        <p className="leading-[75px]">Data Science</p>
      </div>
      <Frame250 />
    </div>
  );
...
function Frame127() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[38px] relative shrink-0 text-[#9c78ff] text-[36px] w-full">Data Science</p>
...
function Frame98() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 text-right w-[290px]">
      ...
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[#9c78ff] text-[40px] uppercase whitespace-nowrap w-full">от 108 700 р.</p>
    </div>
  );
}
    ...
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-start min-w-px relative">
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Анализирую данные и готовлю датасеты для моделей</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Пишу чистый Python-код для анализа данных и ML</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Строю ML-модели и оцениваю качество по метрикам</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Пишу SQL-запросы и работаю с PostgreSQL</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Упаковываю модели в API и готовлю сервисы к деплою</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Провожу EDA, визуализирую выводы и оформляю результаты</span>
        </li>
      </ul>
    </div>
  );
...
function Frame134() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-start min-w-px relative">
      ...
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Настраиваю воспроизводимую среду, Docker и ML-пайплайны</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
      ...
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
          <span className="leading-[30px]">Проверяю качество данных, моделей и экспериментов</span>
        </li>
      </ul>
      <ul className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] block relative shrink-0 w-full">
        <li className="list-disc ms-[36px]">
...
function Frame145() {
  return (
    <div className="content-stretch flex gap-[16px] items-center p-[8px] relative rounded-[16px] shrink-0">
      ...
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[24px] text-black w-[92px]">MLflow</p>
    </div>
  );
}
...
function Frame158() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-start relative shrink-0 w-full">
      <Frame135 />
      <CourseSkillList course="dataScience" variant="desktop" />
    </div>
  );
}
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[24px] items-start relative shrink-0 text-white w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Medium',sans-serif] font-medium leading-[0] relative shrink-0 text-[40px] uppercase w-full whitespace-pre-wrap">
        <p className="leading-[44px] mb-0">{`13 проектных работ `}</p>
  ...
  return (
    <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full site-carousel site-course-projects-carousel" data-carousel="python-projects">
      {dataScienceProjects.map((project, index) => (
        <DataScienceProjectCard index={index} key={project.title} project={project} />
      ))}
    </div>
  );
}
...
function Frame113() {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center p-[16px] relative rounded-[32px] shrink-0">
      <div aria-hidden className="absolute border border-solid border-white inset-0 pointer-events-none rounded-[32px]" />
      <GrommetIconsTask />
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[27px] relative shrink-0 text-[20px] text-white whitespace-nowrap">13 проектных работ</p>
    </div>
  );
}
...
function Frame111() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">(1) Введение в профессию Data Science</p>
...
function CourseTeachersCarouselBlock() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-center relative shrink-0 w-full">
      <DesktopTeacherCarousel carouselId="python-teachers" course preferredRole="Data Scientist" />
...
function Frame212() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[24px] items-start relative shrink-0 uppercase w-full">
      ...
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[40px] text-[rgba(255,255,255,0.6)] w-full">о курсе Data Science</p>
    </div>
  );
}
...
function Frame186() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start justify-center relative shrink-0 w-full">
      ...
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <WeuiDone2Filled2 />
        <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Regular',sans-serif] font-normal leading-[22px] min-w-px relative text-[20px] text-white">13 проектных работ в портфолио</p>
      </div>
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <WeuiDone2Filled3 />
...
function Frame187() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start justify-center relative shrink-0 w-full">
      ...
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <WeuiDone2Filled9 />
        <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Manrope:Regular',sans-serif] font-normal leading-[22px] min-w-px relative text-[#464a6a] text-[20px]">13 проектных работ в портфолио</p>
      </div>
      <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
        <WeuiDone2Filled10 />
...
function Frame198() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start justify-center px-[20px] py-[16px] relative shrink-0">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[40px] uppercase">13</p>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[32px]">
...
function Frame199() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start justify-center px-[20px] py-[16px] relative shrink-0">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[40px] uppercase">48</p>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[32px]">
...
export default function DataScienceCourseDesktop() {
  return (
