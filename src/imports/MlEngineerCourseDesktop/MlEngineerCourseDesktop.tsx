...
import imgMlEngineerHero from "../shared/course-heroes/ml-neural-network.webp";
...
import { mlEngineerCourseProgramModules, type CourseProgramModule } from "../courseProgramData";
import { CourseProgramTagIcon } from "../courseProgramIcons";
import { mlEngineerProjectVisualImages } from "../mlEngineerProjectVisualImages";

const projectVisuals = [
  { title: "Dataset baseline", code: "baseline_forecast.ipynb" },
  { title: "SQL feature mart", code: "feature_mart.sql" },
  { title: "Churn model", code: "churn_model.py" },
  { title: "Demand forecast", code: "demand_forecast.py" },
  { title: "Risk scoring", code: "risk_scoring.py" },
  { title: "Anomaly detection", code: "anomaly_detection.ipynb" },
  { title: "NLP classifier", code: "nlp_classifier.py" },
  { title: "CV classifier", code: "cv_transfer_learning.py" },
  { title: "Recommendation prototype", code: "recommendations.ipynb" },
  { title: "Batch scoring service", code: "batch_scoring/" },
  { title: "ML prediction API", code: "ml_api/" },
...
const mlEngineerProjects = [
  {
    title: "Первичный анализ датасета и baseline-прогноз",
    description:
  ...
  {
    title: "SQL-витрина признаков для ML-модели",
    description:
  ...
  {
    title: "Модель прогнозирования спроса или продаж",
    description:
  ...
  {
    title: "Скоринговая модель оценки риска",
    description:
  ...
  {
    title: "Система поиска аномалий в транзакциях",
    description:
  ...
  {
    title: "NLP-классификатор обращений и отзывов",
    description:
  ...
  {
    title: "CV-прототип классификации изображений",
    description:
  ...
  {
    title: "Рекомендательный прототип для каталога",
    description:
...
function ProjectVisual({ index, compact = false }: { index: number; compact?: boolean }) {
  ...
  const image = mlEngineerProjectVisualImages[index] ?? mlEngineerProjectVisualImages[0];
...
function MlEngineerProjectCard({ project, index }: { project: typeof mlEngineerProjects[number]; index: number }) {
  return (
...
function Frame165() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[10px] items-start relative shrink-0 text-white uppercase w-[1280px]">
      ...
      <h1 className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Bold',sans-serif] font-bold leading-[97px] relative shrink-0 text-[96px] w-full">ML-инженер</h1>
    </div>
  );
}
    ...
    <div className="bg-[rgba(255,255,255,0.6)] h-[599px] relative rounded-[40px] shrink-0 w-full">
      <div className="flex flex-col items-end justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-end justify-between p-[24px] relative size-full">
          <div className="absolute h-[599px] left-0 top-0 w-[1025px]" data-name="Иллюстрация нейронной сети">
            <img
              alt="Объёмная схема нейронной сети"
              className="block brightness-[1.35] h-full hue-rotate-[8deg] max-w-none object-contain pointer-events-none saturate-[1.65] w-full"
              src={imgMlEngineerHero}
            />
          </div>
          <Frame228 />
          <Frame227 />
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[40px] items-start relative shrink-0 text-black w-full">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Medium',sans-serif] font-medium leading-[41px] relative shrink-0 text-[32px] uppercase w-full">
        ML-инженер строит модели, ML-сервисы и воспроизводимые пайплайны по данным{" "}
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[24px] w-full">
        ...
        <p className="leading-[30px]">Программа помогает собрать портфолио из 15 ML-проектов и подготовиться к первым инженерным задачам</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-gradient-to-b flex-[1_0_0] from-[rgba(191,167,255,0.6)] h-[162px] min-w-px relative rounded-tl-[30px] rounded-tr-[30px] shadow-[15px_0px_80px_0px_rgba(156,120,255,0.2)] to-[78.365%] to-[rgba(156,120,255,0.8)]">
      <div className="flex flex-col items-center justify-end size-full">
        <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-center justify-end p-[24px] relative size-full text-white uppercase whitespace-nowrap">
          <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[40px]">{`от 104 700 р.`}</p>
...
function Frame256() {
  return (
    <div className="bg-gradient-to-b drop-shadow-[15px_0px_40px_rgba(156,120,255,0.2)] flex-[1_0_0] from-[#ae90ff] h-[342px] min-w-px relative rounded-tl-[30px] rounded-tr-[30px] to-[#8559ff]">
      <div className="flex flex-col items-center justify-end size-full">
        <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-center justify-end p-[24px] relative size-full text-white uppercase whitespace-nowrap">
          <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[40px]">{`от 189 400 р.`}</p>
...
function Frame257() {
  return (
    <div className="bg-gradient-to-b drop-shadow-[15px_0px_40px_rgba(70,74,106,0.2)] flex-[1_0_0] from-[#7f87cd] h-[562px] min-w-px relative rounded-tl-[30px] rounded-tr-[30px] to-[#464a6a]">
      <div className="flex flex-col items-center justify-end size-full">
        <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-center justify-end p-[24px] relative size-full text-white uppercase whitespace-nowrap">
          <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[40px]">{`от 327 800 р.`}</p>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[80px] items-start relative shrink-0 w-full">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[64px] text-black uppercase w-full">
        ...
        <p className="leading-[75px]">ML-инженер</p>
      </div>
      <Frame250 />
    </div>
  );
...
function Frame127() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[38px] relative shrink-0 text-[#9c78ff] text-[36px] w-full">ML-инженер</p>
...
function Frame98() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 text-right w-[290px]">
      ...
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-[40px] relative shrink-0 text-[#9c78ff] text-[40px] uppercase whitespace-nowrap w-full">от 104 700 р.</p>
    </div>
  );
}
...
function Frame158() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-start relative shrink-0 w-full">
      <Frame135 />
      <CourseSkillList course="mlEngineer" variant="desktop" />
    </div>
  );
}
...
function Frame92() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start relative shrink-0 text-black w-full">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Bold',sans-serif] font-bold leading-[33px] relative shrink-0 text-[32px] uppercase w-full">ML API для модели предсказаний</p>
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[20px] w-full">Обернете модель в FastAPI: endpoint, Pydantic-валидация, тестовый запрос, pytest, Docker-запуск и понятный README</p>
    </div>
  );
}
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start leading-[0] relative shrink-0 text-black w-full">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Raleway:Bold',sans-serif] font-bold relative shrink-0 text-[32px] uppercase w-full">
        ...
        <p className="leading-[33px]">на FastAPI</p>
      </div>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal relative shrink-0 text-[20px] w-full">
        <p className="leading-[22px] mb-0">Разработаете полноценный веб-проект</p>
        <p className="leading-[22px] mb-0">с FastAPI, Docker, PostgreSQL, тестами, мониторингом и воспроизводимым запуском</p>
...
function Frame84() {
  return (
    <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full site-carousel site-course-projects-carousel" data-carousel="python-projects">
      {mlEngineerProjects.map((project, index) => (
        <MlEngineerProjectCard index={index} key={project.title} project={project} />
      ))}
    </div>
  );
}
...
function Frame111() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">(1) Введение в профессию ML-инженер</p>
...
function Frame112() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">{`(2) Python для инженерии машинного обучения `}</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame117() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">{`(3) Продвинутый Python, ООП и структура ML-проекта `}</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
...
function Frame120() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[53px] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">(6) Математические основы ML и метрики моделей</p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
            <div className="absolute inset-[-2.6%_-5.21%_-2.6%_0]">
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative">
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Raleway:Medium',sans-serif] font-medium leading-[0] mr-[-28px] relative shrink-0 text-[40px] text-left text-white uppercase w-[1280px]">
        ...
        <span className="leading-[53px]">FastAPI</span>
      </p>
      <div className="flex items-center justify-center relative shrink-0 size-[28px]">
        <div className="flex-none rotate-90">
          <div className="relative size-[28px]">
...
function Frame110() {
  ...
  return (
    <div className="site-course-program-list site-course-program-list--desktop">
      {mlEngineerCourseProgramModules.map((module, index) => (
...
function Frame198() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start justify-center px-[20px] py-[16px] relative shrink-0">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-['Manrope:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[32px]">
        <p className="leading-[30px] mb-0 whitespace-pre">{`ML-проектов `}</p>
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-w-px relative">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Raleway:Medium',sans-serif] font-medium leading-[0] min-w-px relative text-[40px] text-black text-left uppercase">
        <p className="leading-[53px] mb-0">Слышал, что ML - это слишком сложно</p>
...
export default function MlEngineerCourseDesktop() {
  return (
