...
export const metadata = createPageMetadata({
  title: "ИННОПРОГ - онлайн-школа программирования с наставниками",
  description:
...
export default function HomePage() {
  return (
    <>
      <h1 className="site-seo-heading">ИННОПРОГ - онлайн-школа программирования для взрослых и детей</h1>
