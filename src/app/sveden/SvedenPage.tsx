  ...
  return (
    <>
      ...
      <DetailsTable label="Материально-техническое обеспечение" rows={[
        ...
        ["Доступ в здания для инвалидов и лиц с ОВЗ", <Value itemProp="ovz">Отдельные здания для проведения занятий не используются. Доступность электронной информационно-образовательной среды для инвалидов и лиц с ОВЗ определяется индивидуально</Value>],
