...
export const HOME_SECTION_HEADINGS = [
  ...
  "Преподаватели и обучение на практике",
  "Отзывы учеников ИННОПРОГ",
  "Стоимость и условия обучения",
] as const;

export const COURSE_SECTION_HEADINGS = [
  "Программа курса",
...
export const REVIEWS_SECTION_HEADINGS = [
  "Отзывы учеников о курсах программирования",
  "Отзывы о курсе Python-разработчик",
  "Отзывы о Data Science и аналитике данных",
  "Отзывы о разработке и IT-профессиях",
  "Отзывы по направлениям обучения",
] as const;

export const ABOUT_SECTION_HEADINGS = [
  "О школе ИННОПРОГ",
  "Миссия и подход к обучению",
  "Практическое IT-образование",
  "Документы и правовая информация",
  "Контакты ИННОПРОГ",
] as const;

export const TARIFFS_SECTION_HEADINGS = [
  "Условия оплаты обучения",
  "Налоговый вычет за обучение",
  "Базовый тариф обучения",
  "Расширенный тариф обучения",
  "Персональный тариф обучения",
] as const;

const SEO_SUBSECTION_HEADINGS: Record<string, readonly string[]> = {
  "Курсы программирования для взрослых и детей": [
    "Направления обучения программированию",
    "Курсы для начинающих и продолжающих",
    "Профессии в IT и практические навыки",
    "Выбор подходящего направления",
  ],
  "Индивидуальное обучение с наставником": [
    "Практика и поддержка преподавателя",
    "Индивидуальный учебный план",
    "Обратная связь по заданиям",
    "Занятия в удобном темпе",
  ],
  "Преподаватели и обучение на практике": [
    "Эксперты из IT-индустрии",
    "Практические задания на платформе",
    "Разборы работ с наставником",
    "Навыки для реальных задач",
  ],
  "Отзывы учеников ИННОПРОГ": [
    "Результаты обучения студентов",
    "Опыт учеников на курсах",
    "Истории смены профессии",
    "Мнения о наставниках и программе",
  ],
  "Стоимость и условия обучения": [
    "Форматы и стоимость обучения",
    "Состав тарифов ИННОПРОГ",
    "Оплата обучения частями",
    "Выбор формата занятий",
  ],
  "Программа курса": [
    "Модули и формат обучения",
    "Темы и технологии курса",
  ...
  "Проекты для портфолио": [
    ...
    "Развитие портфолио во время обучения",
    "Навыки для первой работы в IT",
  ],
  "Преподаватели и наставники": [
    "Индивидуальная поддержка в обучении",
    "Преподаватели с опытом в IT",
    "Проверка домашних заданий",
    "Разбор сложных тем на занятиях",
  ],
  "Стоимость обучения": [
    "Выбор подходящего формата занятий",
    "Что входит в стоимость курса",
    "Условия оплаты обучения",
    "Помощь с выбором тарифа",
  ],
  "Часто задаваемые вопросы": [
    "Ответы об обучении на курсе",
    "Начало обучения и уровень подготовки",
    "Документы и результаты обучения",
    "Поддержка во время курса",
  ],
  "Отзывы учеников о курсах программирования": [
    "Реальные истории и результаты обучения",
    "Мнения учеников о программе",
    "Отзывы о занятиях с наставником",
    "Выбор курса по опыту студентов",
  ],
  "Отзывы о курсе Python-разработчик": [
    "Опыт обучения Python с нуля",
    "Отзывы о программе курса Python",
    "Практика и проекты на Python",
    "Результаты учеников Python-разработчика",
  ],
  "Отзывы о Data Science и аналитике данных": [
    "Отзывы о Data Science",
    "Отзывы о курсе Data-аналитик",
    "Практика Python, SQL и аналитики",
    "Результаты учеников в работе с данными",
  ],
  "Отзывы о разработке и IT-профессиях": [
    "Отзывы о frontend- и backend-разработке",
    "Отзывы о Java, C++ и мобильной разработке",
    "Отзывы о курсах Unreal Engine и ML",
    "Переход в IT по опыту учеников",
  ],
  "Отзывы по направлениям обучения": [
    "Выбор курса по отзывам студентов",
    "Фильтры отзывов по направлениям",
    "Истории учеников ИННОПРОГ",
    "Ответы на вопросы об отзывах",
  ],
  "О школе ИННОПРОГ": [
    "Онлайн-школа программирования",
    "Обучение взрослых и детей",
    "Команда ИННОПРОГ",
    "Образовательная платформа школы",
  ],
  "Миссия и подход к обучению": [
    "Практика с первого занятия",
    "Поддержка наставников",
    "Индивидуальный темп обучения",
    "Развитие навыков для IT-профессий",
  ],
  "Практическое IT-образование": [
    "Проекты для портфолио",
  ...
  "Документы и правовая информация": [
    "Лицензия и образовательные документы",
    "Договор и условия обучения",
  ...
  "Базовый тариф обучения": [
    "Состав базового тарифа",
    "Формат занятий с наставником",
    "Практика на образовательной платформе",
    "Кому подходит базовый тариф",
  ],
  "Расширенный тариф обучения": [
    "Состав расширенного тарифа",
    "Дополнительная поддержка в обучении",
    "Практические проекты и обратная связь",
    "Кому подходит расширенный тариф",
  ],
  "Персональный тариф обучения": [
    "Индивидуальный формат занятий",
    "Персональная программа обучения",
    "Поддержка преподавателя",
    "Кому подходит персональный тариф",
  ],
};

export function SeoSectionHeadings({ headings }: { headings: readonly string[] }) {
  return (
    <section aria-label="Основные разделы страницы">
      {headings.map((heading) => {
        const subheadings = SEO_SUBSECTION_HEADINGS[heading] ?? [
          `Основная информация: ${heading}`,
          `Практические детали: ${heading}`,
          `Условия и возможности: ${heading}`,
          `Дополнительная информация: ${heading}`,
        ];

        return (
          <div key={heading}>
            <h2 className="site-seo-heading">{heading}</h2>
            {subheadings.map((subheading) => (
              <h3 key={subheading} className="site-seo-heading">
                {subheading}
              </h3>
            ))}
          </div>
