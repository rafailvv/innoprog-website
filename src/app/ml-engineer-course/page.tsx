...
export const metadata = createPageMetadata({
  ...
  description:
    "Онлайн-курс «ML-инженер» с нуля от ИННОПРОГ. 12 месяцев обучения Python, SQL, машинному обучению, MLOps и нейросетям: программа обучения, цены, диплом о профессиональной переподготовке и помощь в трудоустройстве.",
  absoluteTitle: true,
