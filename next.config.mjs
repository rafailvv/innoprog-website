const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://mc.yandex.ru https://*.mc.yandex.ru https://mc.yandex.com https://*.mc.yandex.com https://mc.yandex.md https://yastatic.net https://*.yastatic.net",
      "style-src 'self' 'unsafe-inline'",
      "font-src 'self' data:",
      "img-src 'self' data: blob: https://mc.yandex.ru https://*.mc.yandex.ru https://mc.yandex.com https://*.mc.yandex.com https://mc.yandex.md https://mc.webvisor.com https://mc.webvisor.org https://yastatic.net https://*.yastatic.net https://api.innoprog.ru",
      "media-src 'self' blob:",
      "connect-src 'self' https://mc.yandex.ru https://*.mc.yandex.ru https://mc.yandex.com https://*.mc.yandex.com https://mc.yandex.md https://mc.webvisor.com https://mc.webvisor.org wss://mc.yandex.ru wss://*.mc.yandex.ru wss://mc.yandex.com wss://*.mc.yandex.com wss://mc.yandex.md wss://mc.webvisor.com wss://mc.webvisor.org https://yastatic.net https://*.yastatic.net https://api.innoprog.ru",
      "child-src 'self' blob: https://mc.yandex.ru https://*.mc.yandex.ru https://mc.yandex.com https://*.mc.yandex.com https://mc.yandex.md https://mc.webvisor.com https://mc.webvisor.org",
      "frame-src 'self' blob: https://mc.yandex.ru https://*.mc.yandex.ru https://mc.yandex.com https://*.mc.yandex.com https://mc.yandex.md https://mc.webvisor.com https://mc.webvisor.org",
